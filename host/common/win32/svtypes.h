...
typedef SV_UCHAR    *SV_PUCHAR;
typedef unsigned short SV_USHORT;
typedef SV_USHORT   *SV_PUSHORT;
...
struct SVERROR
{
	...
	SVERROR_TYPE getTag() { return tag; }
    ...
    char const* toString(char * pszError = NULL, const SV_UINT errorLen = 0);
};
