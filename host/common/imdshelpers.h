...
const char IMDS_COMPUTE_LOCATION[] = "compute.location";
const char IMDS_COMPUTE_VM_ID[] = "compute.vmId";
const char IMDS_COMPUTE_VM_RESOURCE_ID[] = "compute.resourceId";

const char IMDS_ZONAL_FAILOVER_TAG_NAME[] = "SiteRecoveryZonalFailover";
const char IMDS_ZONAL_FAILOVER_LOCATION_TAG_NAME[] = "SiteRecoveryZonalFailoverLocation";

std::string GetImdsMetadata(const std::string& pathStr = std::string(), const std::string& apiVersion = std::string(), const std::string& format = std::string());
