...
$(info    thirdparty.mak: OPENSSL_VERSION = $(OPENSSL_VERSION))
...
# ----------------------------------------------------------------------
thirdparty_build: $(THIRDPARTY_MAK) $(ZLIB_ROOT)/build_zlib $(OPENSSL_ROOT)/build_openssl $(BOOST_ROOT)/build_boost_$(X_CONFIGURATION) $(SQLITE_ROOT)/build_sqlite $(SQLITE3X_ROOT)/build_sqlite3x $(CURL_ROOT)/build_curl $(ACE_ROOT)/build_ace $(LIBSSH2_ROOT)/build_libssh2 $(LIBXML2_ROOT)/build_libxml2 $(INM_MD5_ROOT)/build_inm_md5 thirdparty_links
	$(VERBOSE)touch $@
	$(RULE_SEPARATOR)
