...
set APPLICATION_NAME="RSM"
set APPLICATION_BOOKMARK_MSG="RSM (Removable Storage Manager) consistency point"
...
:GENERATE_TAGS
 %VACP_CMD% -a %APPLICATION_NAME% -t %APPLICATION_BOOKMARK_MSG%
