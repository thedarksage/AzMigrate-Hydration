...
// Hydration Tag
// This tag captures source info and checks if hydration is needed for current system state.
...
//A dummy record consisting of just a TAG GUID 
...
//Since all below structure defined in devicefilter.h we have to remove it from this file
//to avoid redefiniation compiler error
