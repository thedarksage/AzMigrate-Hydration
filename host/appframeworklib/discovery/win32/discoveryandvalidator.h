...
public:
	...
	HostLevelDiscoveryInfo m_hostDiscoveryInfo ;
    ...
    SVERROR getDiscoveryInstanceList(std::list<std::string>& sqlInstancesList);
    SVERROR getReadinessDiscoveryInstanceList(std::list<std::string>& sqlInstancesList);
} ;
