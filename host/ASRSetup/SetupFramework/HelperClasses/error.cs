...
{
    /// <summary>
    /// Win32 Error codes as defined in winerr.h
    /// </summary>
    public static class Win32ErrorCodes
    {
        ...
        public const UInt32 ERROR_TOO_MANY_OPEN_FILES        = 4;
        ...
        public const UInt32 ERROR_ARENA_TRASHED              = 7;
        ...
        public const UInt32 ERROR_INVALID_BLOCK              = 9;

        /// <summary>The environment is incorrect</summary>
        public const UInt32 ERROR_BAD_ENVIRONMENT            = 10;
        ...
        public const UInt32 ERROR_WRITE_PROTECT              = 19;

        /// <summary>The system cannot find the device specified</summary>
        public const UInt32 ERROR_BAD_UNIT                   = 20;

        /// <summary>The device is not ready</summary>
        public const UInt32 ERROR_NOT_READY                  = 21;
        ...
        public const UInt32 ERROR_CRC                        = 23;
        ...
        public const UInt32 ERROR_REM_NOT_LIST               = 51;
        ...
        public const UInt32 ERROR_REQ_NOT_ACCEP              = 71;

        /// <summary>The specified printer or disk device has been paused</summary>
        public const UInt32 ERROR_REDIR_PAUSED               = 72;
        ...
        public const UInt32 ERROR_CANNOT_MAKE                = 82;

        /// <summary>Fail on INT 24</summary>
        public const UInt32 ERROR_FAIL_I24                   = 83;

        /// <summary>Storage to process this request is not available</summary>
        public const UInt32 ERROR_OUT_OF_STRUCTURES          = 84;
        ...
        public const UInt32 ERROR_OPEN_FAILED                = 110;

        /// <summary>The file name is too long</summary>
        public const UInt32 ERROR_BUFFER_OVERFLOW            = 111;
        ...
        public const UInt32 ERROR_INVALID_LEVEL              = 124;

        /// <summary>The disk has no volume label</summary>
        public const UInt32 ERROR_NO_VOLUME_LABEL            = 125;

        /// <summary>The specified module could not be found</summary>
        public const UInt32 ERROR_MOD_NOT_FOUND              = 126;
        ...
        public const UInt32 ERROR_INVALID_FLAG_NUMBER        = 186;

        /// <summary>The specified system semaphore name was not found</summary>
        public const UInt32 ERROR_SEM_NOT_FOUND              = 187;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INVALID_STARTING_CODESEG   = 188;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INVALID_STACKSEG           = 189;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INVALID_MODULETYPE         = 190;

        /// <summary>Cannot run %1 in Win32 mode</summary>
        public const UInt32 ERROR_INVALID_EXE_SIGNATURE      = 191;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_EXE_MARKED_INVALID         = 192;

        /// <summary>%1 is not a valid Win32 application</summary>
        public const UInt32 ERROR_BAD_EXE_FORMAT             = 193;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_ITERATED_DATA_EXCEEDS_64k  = 194;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INVALID_MINALLOCSIZE       = 195;

        /// <summary>The operating system cannot run this application program</summary>
        public const UInt32 ERROR_DYNLINK_FROM_INVALID_RING  = 196;

        /// <summary>The operating system is not presently configured to run this application</summary>
        public const UInt32 ERROR_IOPL_NOT_ENABLED           = 197;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INVALID_SEGDPL             = 198;

        /// <summary>The operating system cannot run this application program</summary>
        public const UInt32 ERROR_AUTODATASEG_EXCEEDS_64k    = 199;

        /// <summary>The code segment cannot be greater than or equal to 64K</summary>
        public const UInt32 ERROR_RING2SEG_MUST_BE_MOVABLE   = 200;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_RELOC_CHAIN_XEEDS_SEGLIM   = 201;

        /// <summary>The operating system cannot run %1</summary>
        public const UInt32 ERROR_INFLOOP_IN_RELOC_CHAIN     = 202;

        /// <summary>The system could not find the environment option that was entered</summary>
        public const UInt32 ERROR_ENVVAR_NOT_FOUND           = 203;

        /// <summary>No process in the command subtree has a signal handler</summary>
        public const UInt32 ERROR_NO_SIGNAL_SENT             = 205;

        /// <summary>The filename or extension is too long</summary>
        public const UInt32 ERROR_FILENAME_EXCED_RANGE       = 206;

        /// <summary>The ring 2 stack is in use</summary>
        public const UInt32 ERROR_RING2_STACK_IN_USE         = 207;
        ...
        public const UInt32 ERROR_FORMS_AUTH_REQUIRED        = 224;

        /// <summary>Operation did not complete successfully because the file contains a virus</summary>
        public const UInt32 ERROR_VIRUS_INFECTED             = 225;
        ...
        public const UInt32 ERROR_VIRUS_DELETED              = 226;

        /// <summary>The pipe is local</summary>
        public const UInt32 ERROR_PIPE_LOCAL                 = 229;

        /// <summary>The pipe state is invalid</summary>
        public const UInt32 ERROR_BAD_PIPE                   = 230;

        /// <summary>All pipe instances are busy</summary>
        public const UInt32 ERROR_PIPE_BUSY                  = 231;
        ...
        public const UInt32 ERROR_VC_DISCONNECTED            = 240;

        /// <summary>The specified extended attribute name was invalid</summary>
        public const UInt32 ERROR_INVALID_EA_NAME            = 254;

        /// <summary>The extended attributes are inconsistent</summary>
        public const UInt32 ERROR_EA_LIST_INCONSISTENT       = 255;
        ...
        public const UInt32 ERROR_TIMER_NOT_CANCELED         = 541;

        /// <summary>Unwind exception code</summary>
        public const UInt32 ERROR_UNWIND                     = 542;

        /// <summary>An invalid or unaligned stack was encountered during an unwind operation</summary>
        public const UInt32 ERROR_BAD_STACK                  = 543;

        /// <summary>An invalid unwind target was encountered during an unwind operation</summary>
        public const UInt32 ERROR_INVALID_UNWIND_TARGET      = 544;

        /// <summary>Invalid Object Attributes specified to NtCreatePort or invalid Port Attributes specified to NtConnectPor</summary>
        public const UInt32 ERROR_INVALID_PORT_ATTRIBUTES    = 545;
        ...
        public const UInt32 ERROR_CANT_TERMINATE_SELF        = 555;
        ...
        //
        public const UInt32 ERROR_UNEXPECTED_MM_CREATE_ERR   = 556;

        /// <summary>If an MM error is returned which is not defined in the standard FsRtl filter, it is converted to one of the following errors which is guaranteed to be in the filter</summary>
        // In this case information is lost, however, the filter correctly handles the exception.
        //
        public const UInt32 ERROR_UNEXPECTED_MM_MAP_ERROR    = 557;

        /// <summary>If an MM error is returned which is not defined in the standard FsRtl filter, it is converted to one of the following errors which is guaranteed to be in the filter</summary>
        // In this case information is lost, however, the filter correctly handles the exception.
        //
        public const UInt32 ERROR_UNEXPECTED_MM_EXTEND_ERR   = 558;

        /// <summary>A malformed function table was encountered during an unwind operation</summary>
        public const UInt32 ERROR_BAD_FUNCTION_TABLE         = 559;
        ...
        //
        public const UInt32 ERROR_NO_GUID_TRANSLATION        = 560;
        ...
        public const UInt32 ERROR_INVALID_LDT_SIZE           = 561;
        ...
        public const UInt32 ERROR_TOO_MANY_THREADS           = 565;
        ...
        public const UInt32 ERROR_THREAD_NOT_IN_PROCESS      = 566;

        /// <summary>Page file quota was exceeded</summary>
        public const UInt32 ERROR_PAGEFILE_QUOTA_EXCEEDED    = 567;
        ...
        public const UInt32 ERROR_LOGON_SERVER_CONFLICT      = 568;
        ...
        public const UInt32 ERROR_SYNCHRONIZATION_REQUIRED   = 569;
        ...
        public const UInt32 ERROR_NET_OPEN_FAILED            = 570;

        /// <summary>{Privilege Failed</summary>
        // The I/O permissions for the process could not be changed.
        //
        public const UInt32 ERROR_IO_PRIVILEGE_FAILED        = 571;

        /// <summary>{Application Exit by CTRL+C</summary>
        // The application terminated as a result of a CTRL+C.
        //
        public const UInt32 ERROR_CONTROL_C_EXIT             = 572;

        /// <summary>{Missing System File</summary>
        // The required system file %hs is bad or missing.
        //
        public const UInt32 ERROR_MISSING_SYSTEMFILE         = 573;

        /// <summary>{Application Error</summary>
        // The exception %s (0x%08lx) occurred in the application at location 0x%08lx.
        //
        public const UInt32 ERROR_UNHANDLED_EXCEPTION        = 574;

        /// <summary>{Application Error</summary>
        // The application failed to initialize properly (0x%lx). Click OK to terminate the application.
        //
        public const UInt32 ERROR_APP_INIT_FAILURE           = 575;

        /// <summary>{Unable to Create Paging File</summary>
        // The creation of the paging file %hs failed (%lx). The requested size was %ld.
        //
        public const UInt32 ERROR_PAGEFILE_CREATE_FAILED     = 576;
        ...
        public const UInt32 ERROR_INVALID_IMAGE_HASH         = 577;

        /// <summary>{No Paging File Specified</summary>
        // No paging file was specified in the system configuration.
        //
        public const UInt32 ERROR_NO_PAGEFILE                = 578;

        /// <summary>{EXCEPTION</summary>
        // A real-mode application issued a floating-point instruction and floating-point hardware is not present.
        //
        public const UInt32 ERROR_ILLEGAL_FLOAT_CONTEXT      = 579;
        ...
        public const UInt32 ERROR_NO_EVENT_PAIR              = 580;

        /// <summary>A Windows Server has an incorrect configuration</summary>
        public const UInt32 ERROR_DOMAIN_CTRLR_CONFIG_ERROR  = 581;
        ...
        public const UInt32 ERROR_CLIENT_SERVER_PARAMETERS_INVALID = 597;

        /// <summary>The stream is not a tiny stream</summary>
        public const UInt32 ERROR_NOT_TINY_STREAM            = 598;

        /// <summary>The request must be handled by the stack overflow code</summary>
        public const UInt32 ERROR_STACK_OVERFLOW_READ        = 599;
        ...
        public const UInt32 ERROR_CONVERT_TO_LARGE           = 600;
        ...
        //
        public const UInt32 ERROR_BAD_DLL_ENTRYPOINT         = 609;
        ...
        //
        public const UInt32 ERROR_BAD_SERVICE_ENTRYPOINT     = 610;

        /// <summary>There is an IP address conflict with another system on the networ</summary>
        public const UInt32 ERROR_IP_ADDRESS_CONFLICT1       = 611;

        /// <summary>There is an IP address conflict with another system on the networ</summary>
        public const UInt32 ERROR_IP_ADDRESS_CONFLICT2       = 612;

        /// <summary>{Low On Registry Space</summary>
        // The system has reached the maximum size allowed for the system part of the registry. Additional storage requests will be ignored.
        //
        public const UInt32 ERROR_REGISTRY_QUOTA_LIMIT       = 613;

        /// <summary>A callback return system service cannot be executed when no callback is active</summary>
        public const UInt32 ERROR_NO_CALLBACK_ACTIVE         = 614;

        /// <summary>The password provided is too short to meet the policy of your user account</summary>
        // Please choose a longer password.
        //
        public const UInt32 ERROR_PWD_TOO_SHORT              = 615;
        ...
        // The system has been shut down.
        //
        public const UInt32 ERROR_SYSTEM_IMAGE_BAD_SIGNATURE = 637;

        /// <summary>Device will not start without a reboot</summary>
        public const UInt32 ERROR_PNP_REBOOT_REQUIRED        = 638;

        /// <summary>There is not enough power to complete the requested operation</summary>
        public const UInt32 ERROR_INSUFFICIENT_POWER         = 639;

        /// <summary> ERROR_MULTIPLE_FAULT_VIOLATIO</summary>
        public const UInt32 ERROR_MULTIPLE_FAULT_VIOLATION   = 640;

        /// <summary>The system is in the process of shutting down</summary>
        public const UInt32 ERROR_SYSTEM_SHUTDOWN            = 641;
        ...
        public const UInt32 ERROR_PORT_NOT_SET               = 642;
        ...
        public const UInt32 ERROR_MOUNT_POINT_NOT_RESOLVED   = 649;
        ...
        public const UInt32 ERROR_HIBERNATION_FAILURE        = 656;

        /// <summary>The requested operation could not be completed due to a file system limitatio</summary>
        public const UInt32 ERROR_FILE_SYSTEM_LIMITATION     = 665;

        /// <summary>An assertion failure has occurred</summary>
        public const UInt32 ERROR_ASSERTION_FAILURE          = 668;

        /// <summary>An error occurred in the ACPI subsystem</summary>
        public const UInt32 ERROR_ACPI_ERROR                 = 669;

        /// <summary>WOW Assertion Error</summary>
        public const UInt32 ERROR_WOW_ASSERTION              = 670;

        /// <summary>A device is missing in the system BIOS MPS table. This device will not be used</summary>
        // Please contact your system vendor for system BIOS update.
        //
        public const UInt32 ERROR_PNP_BAD_MPS_TABLE          = 671;

        /// <summary>A translator failed to translate resources</summary>
        public const UInt32 ERROR_PNP_TRANSLATION_FAILED     = 672;

        /// <summary>A IRQ translator failed to translate resources</summary>
        public const UInt32 ERROR_PNP_IRQ_TRANSLATION_FAILED = 673;

        /// <summary>Driver %2 returned invalid ID for a child device (%3)</summary>
        public const UInt32 ERROR_PNP_INVALID_ID             = 674;

        /// <summary>{Kernel Debugger Awakened</summary>
        // the system debugger was awakened by an interrupt.
        //
        public const UInt32 ERROR_WAKE_SYSTEM_DEBUGGER       = 675;

        /// <summary>{Handles Closed</summary>
        // Handles to objects have been automatically closed as a result of the requested operation.
        //
        public const UInt32 ERROR_HANDLES_CLOSED             = 676;

        /// <summary>{Too Much Information</summary>
        // The specified access control list (ACL) contained more information than was expected.
        //
        public const UInt32 ERROR_EXTRANEOUS_INFORMATION     = 677;
        ...
        //
        public const UInt32 ERROR_RXACT_COMMIT_NECESSARY     = 678;

        /// <summary>{Media Changed</summary>
        // The media may have changed.
        //
        public const UInt32 ERROR_MEDIA_CHECK                = 679;
        ...
        //
        public const UInt32 ERROR_GUID_SUBSTITUTION_MADE     = 680;

        /// <summary>The create operation stopped after reaching a symbolic lin</summary>
        public const UInt32 ERROR_STOPPED_ON_SYMLINK         = 681;

        /// <summary>A long jump has been executed</summary>
        public const UInt32 ERROR_LONGJUMP                   = 682;

        /// <summary>The Plug and Play query operation was not successful</summary>
        public const UInt32 ERROR_PLUGPLAY_QUERY_VETOED      = 683;

        /// <summary>A frame consolidation has been executed</summary>
        public const UInt32 ERROR_UNWIND_CONSOLIDATE         = 684;
        ...
        //
        public const UInt32 ERROR_REGISTRY_HIVE_RECOVERED    = 685;
        ...
        public const UInt32 ERROR_DLL_MIGHT_BE_INSECURE      = 686;
        ...
        public const UInt32 ERROR_DLL_MIGHT_BE_INCOMPATIBLE  = 687;

        /// <summary>Debugger did not handle the exception</summary>
        public const UInt32 ERROR_DBG_EXCEPTION_NOT_HANDLED  = 688;

        /// <summary>Debugger will reply later</summary>
        public const UInt32 ERROR_DBG_REPLY_LATER            = 689;

        /// <summary>Debugger cannot provide handle</summary>
        public const UInt32 ERROR_DBG_UNABLE_TO_PROVIDE_HANDLE = 690;

        /// <summary>Debugger terminated thread</summary>
        public const UInt32 ERROR_DBG_TERMINATE_THREAD       = 691;

        /// <summary>Debugger terminated process</summary>
        public const UInt32 ERROR_DBG_TERMINATE_PROCESS      = 692;

        /// <summary>Debugger got control C</summary>
        public const UInt32 ERROR_DBG_CONTROL_C              = 693;

        /// <summary>Debugger printed exception on control C</summary>
        public const UInt32 ERROR_DBG_PRINTEXCEPTION_C       = 694;

        /// <summary>Debugger received RIP exception</summary>
        public const UInt32 ERROR_DBG_RIPEXCEPTION           = 695;

        /// <summary>Debugger received control break</summary>
        public const UInt32 ERROR_DBG_CONTROL_BREAK          = 696;

        /// <summary>Debugger command communication exception</summary>
        public const UInt32 ERROR_DBG_COMMAND_EXCEPTION      = 697;

        /// <summary>{Object Exists</summary>
        // An attempt was made to create an object and the object name already existed.
        //
        public const UInt32 ERROR_OBJECT_NAME_EXISTS         = 698;

        /// <summary>{Thread Suspended</summary>
        // A thread termination occurred while the thread was suspended. The thread was resumed, and termination proceeded.
        //
        public const UInt32 ERROR_THREAD_WAS_SUSPENDED       = 699;

        /// <summary>{Image Relocated</summary>
        // An image file could not be mapped at the address specified in the image file. Local fixups must be performed on this image.
        //
        public const UInt32 ERROR_IMAGE_NOT_AT_BASE          = 700;
        ...
        public const UInt32 ERROR_RXACT_STATE_CREATED        = 701;

        /// <summary>{Segment Load</summary>
        // A virtual DOS machine (VDM) is loading, unloading, or moving an MS-DOS or Win16 program segment image.
        // An exception is raised so a debugger can load, unload or track symbols and breakpoints within these 16-bit segments.
        //
        public const UInt32 ERROR_SEGMENT_NOTIFICATION       = 702;

        /// <summary>{Invalid Current Directory</summary>
        // The process cannot switch to the startup current directory %hs.
        // Select OK to set current directory to %hs, or select CANCEL to exit.
        //
        public const UInt32 ERROR_BAD_CURRENT_DIRECTORY      = 703;

        /// <summary>{Redundant Read</summary>
        // To satisfy a read request, the NT fault-tolerant file system successfully read the requested data from a redundant copy.
        // This was done because the file system encountered a failure on a member of the fault-tolerant volume, but was unable to reassign the failing area of the device.
        //
        public const UInt32 ERROR_FT_READ_RECOVERY_FROM_BACKUP = 704;

        /// <summary>{Redundant Write</summary>
        // To satisfy a write request, the NT fault-tolerant file system successfully wrote a redundant copy of the information.
        // This was done because the file system encountered a failure on a member of the fault-tolerant volume, but was not able to reassign the failing area of the device.
        //
        public const UInt32 ERROR_FT_WRITE_RECOVERY          = 705;

        /// <summary>{Machine Type Mismatch</summary>
        // The image file %hs is valid, but is for a machine type other than the current machine. Select OK to continue, or CANCEL to fail the DLL load.
        //
        public const UInt32 ERROR_IMAGE_MACHINE_TYPE_MISMATCH = 706;

        /// <summary>{Partial Data Received</summary>
        // The network transport returned partial data to its client. The remaining data will be sent later.
        //
        public const UInt32 ERROR_RECEIVE_PARTIAL            = 707;

        /// <summary>{Expedited Data Received</summary>
        // The network transport returned data to its client that was marked as expedited by the remote system.
        //
        public const UInt32 ERROR_RECEIVE_EXPEDITED          = 708;

        /// <summary>{Partial Expedited Data Received</summary>
        // The network transport returned partial data to its client and this data was marked as expedited by the remote system. The remaining data will be sent later.
        //
        public const UInt32 ERROR_RECEIVE_PARTIAL_EXPEDITED  = 709;

        /// <summary>{TDI Event Done</summary>
        // The TDI indication has completed successfully.
        //
        public const UInt32 ERROR_EVENT_DONE                 = 710;

        /// <summary>{TDI Event Pending</summary>
        // The TDI indication has entered the pending state.
        //
        public const UInt32 ERROR_EVENT_PENDING              = 711;

        /// <summary>Checking file system on %w</summary>
        public const UInt32 ERROR_CHECKING_FILE_SYSTEM       = 712;

        /// <summary>{Fatal Application Exit</summary>
        // %hs
        //
        public const UInt32 ERROR_FATAL_APP_EXIT             = 713;

        /// <summary>The specified registry key is referenced by a predefined handle</summary>
        public const UInt32 ERROR_PREDEFINED_HANDLE          = 714;

        /// <summary>{Page Unlocked</summary>
        // The page protection of a locked page was changed to 'No Access' and the page was unlocked from memory and from the process.
        //
        public const UInt32 ERROR_WAS_UNLOCKED               = 715;

        /// <summary>%h</summary>
        public const UInt32 ERROR_SERVICE_NOTIFICATION       = 716;

        /// <summary>{Page Locked</summary>
        // One of the pages to lock was already locked.
        //
        public const UInt32 ERROR_WAS_LOCKED                 = 717;

        /// <summary>Application popup: %1 : %</summary>
        public const UInt32 ERROR_LOG_HARD_ERROR             = 718;

        /// <summary> ERROR_ALREADY_WIN3</summary>
        public const UInt32 ERROR_ALREADY_WIN32              = 719;

        /// <summary>{Machine Type Mismatch</summary>
        // The image file %hs is valid, but is for a machine type other than the current machine.
        //
        public const UInt32 ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE = 720;

        /// <summary>A yield execution was performed and no thread was available to run</summary>
        public const UInt32 ERROR_NO_YIELD_PERFORMED         = 721;

        /// <summary>The resumable flag to a timer API was ignored</summary>
        public const UInt32 ERROR_TIMER_RESUME_IGNORED       = 722;

        /// <summary>The arbiter has deferred arbitration of these resources to its paren</summary>
        public const UInt32 ERROR_ARBITRATION_UNHANDLED      = 723;

        /// <summary>The inserted CardBus device cannot be started because of a configuration error on "%hs"</summary>
        public const UInt32 ERROR_CARDBUS_NOT_SUPPORTED      = 724;
        ...
        public const UInt32 ERROR_MP_PROCESSOR_MISMATCH      = 725;

        /// <summary>The system was put into hibernation</summary>
        public const UInt32 ERROR_HIBERNATED                 = 726;

        /// <summary>The system was resumed from hibernation</summary>
        public const UInt32 ERROR_RESUME_HIBERNATION         = 727;
        ...
        public const UInt32 ERROR_FIRMWARE_UPDATED           = 728;
        ...
        public const UInt32 ERROR_DRIVERS_LEAKING_LOCKED_PAGES = 729;

        /// <summary>The system has awoke</summary>
        public const UInt32 ERROR_WAKE_SYSTEM                = 730;

        /// <summary> ERROR_WAIT_</summary>
        public const UInt32 ERROR_WAIT_1                     = 731;

        /// <summary> ERROR_WAIT_</summary>
        public const UInt32 ERROR_WAIT_2                     = 732;

        /// <summary> ERROR_WAIT_</summary>
        public const UInt32 ERROR_WAIT_3                     = 733;

        /// <summary> ERROR_WAIT_6</summary>
        public const UInt32 ERROR_WAIT_63                    = 734;

        /// <summary> ERROR_ABANDONED_WAIT_</summary>
        public const UInt32 ERROR_ABANDONED_WAIT_0           = 735;

        /// <summary> ERROR_ABANDONED_WAIT_6</summary>
        public const UInt32 ERROR_ABANDONED_WAIT_63          = 736;

        /// <summary> ERROR_USER_AP</summary>
        public const UInt32 ERROR_USER_APC                   = 737;

        /// <summary> ERROR_KERNEL_AP</summary>
        public const UInt32 ERROR_KERNEL_APC                 = 738;

        /// <summary> ERROR_ALERTE</summary>
        public const UInt32 ERROR_ALERTED                    = 739;

        /// <summary>The requested operation requires elevation</summary>
        public const UInt32 ERROR_ELEVATION_REQUIRED         = 740;
        ...
        //
        public const UInt32 ERROR_RXACT_COMMITTED            = 744;
        ...
        public const UInt32 ERROR_NOTIFY_CLEANUP             = 745;

        /// <summary>{Connect Failure on Primary Transport</summary>
        // An attempt was made to connect to the remote server %hs on the primary transport, but the connection failed.
        // The computer WAS able to connect on a secondary transport.
        //
        public const UInt32 ERROR_PRIMARY_TRANSPORT_CONNECT_FAILED = 746;

        /// <summary>Page fault was a transition fault</summary>
        public const UInt32 ERROR_PAGE_FAULT_TRANSITION      = 747;

        /// <summary>Page fault was a demand zero fault</summary>
        public const UInt32 ERROR_PAGE_FAULT_DEMAND_ZERO     = 748;

        /// <summary>Page fault was a demand zero fault</summary>
        public const UInt32 ERROR_PAGE_FAULT_COPY_ON_WRITE   = 749;

        /// <summary>Page fault was a demand zero fault</summary>
        public const UInt32 ERROR_PAGE_FAULT_GUARD_PAGE      = 750;

        /// <summary>Page fault was satisfied by reading from a secondary storage device</summary>
        public const UInt32 ERROR_PAGE_FAULT_PAGING_FILE     = 751;

        /// <summary>Cached page was locked during operation</summary>
        public const UInt32 ERROR_CACHE_PAGE_LOCKED          = 752;

        /// <summary>Crash dump exists in paging file</summary>
        public const UInt32 ERROR_CRASH_DUMP                 = 753;

        /// <summary>Specified buffer contains all zeros</summary>
        public const UInt32 ERROR_BUFFER_ALL_ZEROS           = 754;

        /// <summary>A reparse should be performed by the Object Manager since the name of the file resulted in a symbolic link</summary>
        public const UInt32 ERROR_REPARSE_OBJECT             = 755;

        /// <summary>The device has succeeded a query-stop and its resource requirements have changed</summary>
        public const UInt32 ERROR_RESOURCE_REQUIREMENTS_CHANGED = 756;
        ...
        public const UInt32 ERROR_TRANSLATION_COMPLETE       = 757;

        /// <summary>A process being terminated has no threads to terminate</summary>
        public const UInt32 ERROR_NOTHING_TO_TERMINATE       = 758;

        /// <summary>The specified process is not part of a job</summary>
        public const UInt32 ERROR_PROCESS_NOT_IN_JOB         = 759;

        /// <summary>The specified process is part of a job</summary>
        public const UInt32 ERROR_PROCESS_IN_JOB             = 760;

        /// <summary>{Volume Shadow Copy Service</summary>
        // The system is now ready for hibernation.
        //
        public const UInt32 ERROR_VOLSNAP_HIBERNATE_READY    = 761;

        /// <summary>A file system or file system filter driver has successfully completed an FsFilter operation</summary>
        public const UInt32 ERROR_FSFILTER_OP_COMPLETED_SUCCESSFULLY = 762;

        /// <summary>The specified interrupt vector was already connected</summary>
        public const UInt32 ERROR_INTERRUPT_VECTOR_ALREADY_CONNECTED = 763;

        /// <summary>The specified interrupt vector is still connected</summary>
        public const UInt32 ERROR_INTERRUPT_STILL_CONNECTED  = 764;

        /// <summary>An operation is blocked waiting for an oplock</summary>
        public const UInt32 ERROR_WAIT_FOR_OPLOCK            = 765;

        /// <summary>Debugger handled exceptio</summary>
        public const UInt32 ERROR_DBG_EXCEPTION_HANDLED      = 766;

        /// <summary>Debugger continue</summary>
        public const UInt32 ERROR_DBG_CONTINUE               = 767;

        /// <summary>An exception occurred in a user mode callback and the kernel callback frame should be removed</summary>
        public const UInt32 ERROR_CALLBACK_POP_STACK         = 768;

        /// <summary>Compression is disabled for this volume</summary>
        public const UInt32 ERROR_COMPRESSION_DISABLED       = 769;

        /// <summary>The data provider cannot fetch backwards through a result set</summary>
        public const UInt32 ERROR_CANTFETCHBACKWARDS         = 770;

        /// <summary>The data provider cannot scroll backwards through a result set</summary>
        public const UInt32 ERROR_CANTSCROLLBACKWARDS        = 771;

        /// <summary>The data provider requires that previously fetched data is released before asking for more data</summary>
        public const UInt32 ERROR_ROWSNOTRELEASED            = 772;

        /// <summary>The data provider was not able to intrepret the flags set for a column binding in an accessor</summary>
        public const UInt32 ERROR_BAD_ACCESSOR_FLAGS         = 773;

        /// <summary>One or more errors occurred while processing the request</summary>
        public const UInt32 ERROR_ERRORS_ENCOUNTERED         = 774;

        /// <summary>The implementation is not capable of performing the request</summary>
        public const UInt32 ERROR_NOT_CAPABLE                = 775;
        ...
        public const UInt32 ERROR_REQUEST_OUT_OF_SEQUENCE    = 776;

        /// <summary>A version number could not be parsed</summary>
        public const UInt32 ERROR_VERSION_PARSE_ERROR        = 777;

        /// <summary>The iterator's start position is invalid</summary>
        public const UInt32 ERROR_BADSTARTPOSITION           = 778;

        /// <summary>The hardware has reported an uncorrectable memory error</summary>
        public const UInt32 ERROR_MEMORY_HARDWARE            = 779;

        /// <summary>The attempted operation required self healing to be enabled</summary>
        public const UInt32 ERROR_DISK_REPAIR_DISABLED       = 780;

        /// <summary>The Desktop heap encountered an error while allocating session memory</summary>
        // There is more information in the system event log.
        //
        public const UInt32 ERROR_INSUFFICIENT_RESOURCE_FOR_SPECIFIED_SHARED_SECTION_SIZE = 781;

        /// <summary>The system powerstate is transitioning from %2 to %3</summary>
        public const UInt32 ERROR_SYSTEM_POWERSTATE_TRANSITION = 782;

        /// <summary>The system powerstate is transitioning from %2 to %3 but could enter %4</summary>
        public const UInt32 ERROR_SYSTEM_POWERSTATE_COMPLEX_TRANSITION = 783;

        /// <summary>A thread is getting dispatched with MCA EXCEPTION because of MCA</summary>
        public const UInt32 ERROR_MCA_EXCEPTION              = 784;

        /// <summary>Access to %1 is monitored by policy rule %2</summary>
        public const UInt32 ERROR_ACCESS_AUDIT_BY_POLICY     = 785;

        /// <summary>Access to %1 has been restricted by your Administrator by policy rule %2</summary>
        public const UInt32 ERROR_ACCESS_DISABLED_NO_SAFER_UI_BY_POLICY = 786;

        /// <summary>A valid hibernation file has been invalidated and should be abandoned</summary>
        public const UInt32 ERROR_ABANDON_HIBERFILE          = 787;

        /// <summary>{Delayed Write Failed</summary>
        // Windows was unable to save all the data for the file %hs; the data has been lost.
        // This error may be caused by network connectivity issues. Please try to save this file elsewhere.
        //
        public const UInt32 ERROR_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED = 788;

        /// <summary>{Delayed Write Failed</summary>
        // Windows was unable to save all the data for the file %hs; the data has been lost.
        // This error was returned by the server on which the file exists. Please try to save this file elsewhere.
        //
        public const UInt32 ERROR_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR = 789;

        /// <summary>{Delayed Write Failed</summary>
        // Windows was unable to save all the data for the file %hs; the data has been lost.
        // This error may be caused if the device has been removed or the media is write-protected.
        //
        public const UInt32 ERROR_LOST_WRITEBEHIND_DATA_LOCAL_DISK_ERROR = 790;

        /// <summary>The resources required for this device conflict with the MCFG table</summary>
        public const UInt32 ERROR_BAD_MCFG_TABLE             = 791;

        /// <summary>Access to the extended attribute was denied</summary>
        public const UInt32 ERROR_EA_ACCESS_DENIED           = 994;
        ...
        public const UInt32 ERROR_REGISTRY_RECOVERED         = 1014;
        ...
        public const UInt32 ERROR_REGISTRY_CORRUPT           = 1015;
        ...
        public const UInt32 ERROR_REGISTRY_IO_FAILED         = 1016;
        ...
        public const UInt32 ERROR_INVALID_SERVICE_ACCOUNT    = 1057;
        ...
        public const UInt32 ERROR_SERVICE_DISABLED           = 1058;

        /// <summary>Circular service dependency was specified</summary>
        public const UInt32 ERROR_CIRCULAR_DEPENDENCY        = 1059;

        /// <summary>The specified service does not exist as an installed service</summary>
        public const UInt32 ERROR_SERVICE_DOES_NOT_EXIST     = 1060;

        /// <summary>The service cannot accept control messages at this time</summary>
        public const UInt32 ERROR_SERVICE_CANNOT_ACCEPT_CTRL = 1061;
        ...
        public const UInt32 ERROR_UNABLE_TO_MOVE_REPLACEMENT = 1176;
        ...
        public const UInt32 ERROR_UNABLE_TO_MOVE_REPLACEMENT_2 = 1177;
        ...
        public const UInt32 ERROR_SESSION_CREDENTIAL_CONFLICT = 1219;
        ...
        public const UInt32 ERROR_CONNECTION_COUNT_LIMIT     = 1238;

        /// <summary>Attempting to log in during an unauthorized time of day for this account</summary>
        public const UInt32 ERROR_LOGIN_TIME_RESTRICTION     = 1239;

        /// <summary>The account is not authorized to log in from this station</summary>
        public const UInt32 ERROR_LOGIN_WKSTA_RESTRICTION    = 1240;

        /// <summary>The network address could not be used for the operation requested</summary>
        public const UInt32 ERROR_INCORRECT_ADDRESS          = 1241;

        /// <summary>The service is already registered</summary>
        public const UInt32 ERROR_ALREADY_REGISTERED         = 1242;

        /// <summary>The specified service does not exist</summary>
        public const UInt32 ERROR_SERVICE_NOT_FOUND          = 1243;

        /// <summary>The operation being requested was not performed because the user has not been authenticated</summary>
        public const UInt32 ERROR_NOT_AUTHENTICATED          = 1244;

        /// <summary>The operation being requested was not performed because the user has not logged on to the network</summary>
        // The specified service does not exist.
        //
        public const UInt32 ERROR_NOT_LOGGED_ON              = 1245;

        /// <summary>Continue with work in progress</summary>
        public const UInt32 ERROR_CONTINUE                   = 1246;
        ...
        public const UInt32 ERROR_REG_NAT_CONSUMPTION        = 1261;

        /// <summary>The share is currently offline or does not exist</summary>
        public const UInt32 ERROR_CSCSHARE_OFFLINE           = 1262;
        ...
        public const UInt32 ERROR_DOWNGRADE_DETECTED         = 1265;
        ...
        public const UInt32 ERROR_ACCESS_DISABLED_WEBBLADE_TAMPER = 1278;

        /// <summary>A transaction recover failed</summary>
        public const UInt32 ERROR_RECOVERY_FAILURE           = 1279;

        /// <summary>The current thread has already been converted to a fiber</summary>
        public const UInt32 ERROR_ALREADY_FIBER              = 1280;

        /// <summary>The current thread has already been converted from a fiber</summary>
        public const UInt32 ERROR_ALREADY_THREAD             = 1281;
        ...
        public const UInt32 ERROR_STACK_BUFFER_OVERRUN       = 1282;

        /// <summary>Data present in one of the parameters is more than the function can operate on</summary>
        public const UInt32 ERROR_PARAMETER_QUOTA_EXCEEDED   = 1283;
        ...
        public const UInt32 ERROR_CONTENT_BLOCKED            = 1296;
        ...
        //
        public const UInt32 ERROR_INCOMPATIBLE_SERVICE_PRIVILEGE = 1297;
        ...
        public const UInt32 ERROR_ILL_FORMED_PASSWORD        = 1324;
        ...
        public const UInt32 ERROR_PASSWORD_RESTRICTION       = 1325;

        /// <summary>Logon failure: unknown user name or bad password</summary>
        public const UInt32 ERROR_LOGON_FAILURE              = 1326;
        ...
        public const UInt32 ERROR_CANT_ACCESS_DOMAIN_INFO    = 1351;
        ...
        public const UInt32 ERROR_INVALID_TASK_NAME          = 1550;

        /// <summary>The specified task index is invalid</summary>
        public const UInt32 ERROR_INVALID_TASK_INDEX         = 1551;

        /// <summary>The specified thread is already joining a task</summary>
        public const UInt32 ERROR_THREAD_ALREADY_IN_TASK     = 1552;
        ...
        public const UInt32 ERROR_INSTALL_SOURCE_ABSENT      = 1612;
        ...
        public const UInt32 ERROR_INSTALL_PACKAGE_VERSION    = 1613;

        /// <summary>Product is uninstalled</summary>
        public const UInt32 ERROR_PRODUCT_UNINSTALLED        = 1614;

        /// <summary>SQL query syntax invalid or unsupported</summary>
        public const UInt32 ERROR_BAD_QUERY_SYNTAX           = 1615;

        /// <summary>Record field does not exist</summary>
        public const UInt32 ERROR_INVALID_FIELD              = 1616;

        /// <summary>The device has been removed</summary>
        public const UInt32 ERROR_DEVICE_REMOVED             = 1617;
        ...
        public const UInt32 ERROR_INSTALL_ALREADY_RUNNING    = 1618;
        ...
        public const UInt32 ERROR_INSTALL_PACKAGE_OPEN_FAILED = 1619;
        ...
        public const UInt32 ERROR_PATCH_PACKAGE_OPEN_FAILED  = 1635;
        ...
        public const UInt32 ERROR_PATCH_PACKAGE_INVALID      = 1636;
        ...
        public const UInt32 ERROR_PATCH_PACKAGE_UNSUPPORTED  = 1637;
        ...
        public const UInt32 ERROR_INSTALL_REMOTE_DISALLOWED  = 1640;
        ...
        public const UInt32 ERROR_SUCCESS_REBOOT_INITIATED   = 1641;
        ...
        public const UInt32 ERROR_PATCH_MANAGED_ADVERTISED_PRODUCT = 1651;
        ...
        public const UInt32 ERROR_INSTALL_SERVICE_SAFEBOOT   = 1652;
        ...
        public const UInt32 ERROR_NOLOGON_INTERDOMAIN_TRUST_ACCOUNT = 1807;
        ...
        public const UInt32 ERROR_NOLOGON_WORKSTATION_TRUST_ACCOUNT = 1808;
        ...
        public const UInt32 ERROR_NOLOGON_SERVER_TRUST_ACCOUNT = 1809;
        ...
        /// <summary>Reissue the given operation as a cached IO operatio</summary>
        public const UInt32 ERROR_IO_REISSUE_AS_CACHED       = 3950;
        ...
        public const UInt32 ERROR_DHCP_ADDRESS_CONFLICT      = 4100;
        ...
        public const UInt32 ERROR_INDIGENOUS_TYPE            = 4338;
        ...
        public const UInt32 ERROR_NO_SUPPORTING_DRIVES       = 4339;

        /// <summary>A cleaner cartridge is present in the tape library</summary>
        public const UInt32 ERROR_CLEANER_CARTRIDGE_INSTALLED = 4340;

        /// <summary>Cannot use the ieport because it is not empty</summary>
        public const UInt32 ERROR_IEPORT_FULL                = 4341;
        ...
        public const UInt32 ERROR_FILE_OFFLINE               = 4350;

        /// <summary>The remote storage service is not operational at this time</summary>
        public const UInt32 ERROR_REMOTE_STORAGE_NOT_ACTIVE  = 4351;

        /// <summary>The remote storage service encountered a media error</summary>
        public const UInt32 ERROR_REMOTE_STORAGE_MEDIA_ERROR = 4352;
        ...
        public const UInt32 ERROR_VOLUME_NOT_SIS_ENABLED     = 4500;
        ...
        public const UInt32 ERROR_RESOURCE_PROPERTIES_STORED = 5024;
        ...
        public const UInt32 ERROR_QUORUM_OWNER_ALIVE         = 5034;

        /// <summary>A cluster network is not available for this operation</summary>
        public const UInt32 ERROR_NETWORK_NOT_AVAILABLE      = 5035;

        /// <summary>A cluster node is not available for this operation</summary>
        public const UInt32 ERROR_NODE_NOT_AVAILABLE         = 5036;

        /// <summary>All cluster nodes must be running to perform this operation</summary>
        public const UInt32 ERROR_ALL_NODES_NOT_AVAILABLE    = 5037;

        /// <summary>A cluster resource failed</summary>
        public const UInt32 ERROR_RESOURCE_FAILED            = 5038;

        /// <summary>The cluster node is not valid</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_NODE       = 5039;

        /// <summary>The cluster node already exists</summary>
        public const UInt32 ERROR_CLUSTER_NODE_EXISTS        = 5040;

        /// <summary>A node is in the process of joining the cluster</summary>
        public const UInt32 ERROR_CLUSTER_JOIN_IN_PROGRESS   = 5041;

        /// <summary>The cluster node was not found</summary>
        public const UInt32 ERROR_CLUSTER_NODE_NOT_FOUND     = 5042;

        /// <summary>The cluster local node information was not found</summary>
        public const UInt32 ERROR_CLUSTER_LOCAL_NODE_NOT_FOUND = 5043;

        /// <summary>The cluster network already exists</summary>
        public const UInt32 ERROR_CLUSTER_NETWORK_EXISTS     = 5044;

        /// <summary>The cluster network was not found</summary>
        public const UInt32 ERROR_CLUSTER_NETWORK_NOT_FOUND  = 5045;

        /// <summary>The cluster network interface already exists</summary>
        public const UInt32 ERROR_CLUSTER_NETINTERFACE_EXISTS = 5046;

        /// <summary>The cluster network interface was not found</summary>
        public const UInt32 ERROR_CLUSTER_NETINTERFACE_NOT_FOUND = 5047;

        /// <summary>The cluster request is not valid for this object</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_REQUEST    = 5048;

        /// <summary>The cluster network provider is not valid</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_NETWORK_PROVIDER = 5049;

        /// <summary>The cluster node is down</summary>
        public const UInt32 ERROR_CLUSTER_NODE_DOWN          = 5050;

        /// <summary>The cluster node is not reachable</summary>
        public const UInt32 ERROR_CLUSTER_NODE_UNREACHABLE   = 5051;

        /// <summary>The cluster node is not a member of the cluster</summary>
        public const UInt32 ERROR_CLUSTER_NODE_NOT_MEMBER    = 5052;

        /// <summary>A cluster join operation is not in progress</summary>
        public const UInt32 ERROR_CLUSTER_JOIN_NOT_IN_PROGRESS = 5053;

        /// <summary>The cluster network is not valid</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_NETWORK    = 5054;

        /// <summary>The cluster node is up</summary>
        public const UInt32 ERROR_CLUSTER_NODE_UP            = 5056;

        /// <summary>The cluster IP address is already in use</summary>
        public const UInt32 ERROR_CLUSTER_IPADDR_IN_USE      = 5057;

        /// <summary>The cluster node is not paused</summary>
        public const UInt32 ERROR_CLUSTER_NODE_NOT_PAUSED    = 5058;

        /// <summary>No cluster security context is available</summary>
        public const UInt32 ERROR_CLUSTER_NO_SECURITY_CONTEXT = 5059;

        /// <summary>The cluster network is not configured for internal cluster communication</summary>
        public const UInt32 ERROR_CLUSTER_NETWORK_NOT_INTERNAL = 5060;

        /// <summary>The cluster node is already up</summary>
        public const UInt32 ERROR_CLUSTER_NODE_ALREADY_UP    = 5061;

        /// <summary>The cluster node is already down</summary>
        public const UInt32 ERROR_CLUSTER_NODE_ALREADY_DOWN  = 5062;

        /// <summary>The cluster network is already online</summary>
        public const UInt32 ERROR_CLUSTER_NETWORK_ALREADY_ONLINE = 5063;

        /// <summary>The cluster network is already offline</summary>
        public const UInt32 ERROR_CLUSTER_NETWORK_ALREADY_OFFLINE = 5064;

        /// <summary>The cluster node is already a member of the cluster</summary>
        public const UInt32 ERROR_CLUSTER_NODE_ALREADY_MEMBER = 5065;
        ...
        public const UInt32 ERROR_CLUSTER_LAST_INTERNAL_NETWORK = 5066;
        ...
        public const UInt32 ERROR_CLUSTER_NETWORK_HAS_DEPENDENTS = 5067;
        ...
        public const UInt32 ERROR_CLUSTER_INCOMPATIBLE_VERSIONS = 5075;
        ...
        public const UInt32 ERROR_CLUSTER_MAXNUM_OF_RESOURCES_EXCEEDED = 5076;
        ...
        public const UInt32 ERROR_CLUSTER_SYSTEM_CONFIG_CHANGED = 5077;

        /// <summary>The specified resource type was not found</summary>
        public const UInt32 ERROR_CLUSTER_RESOURCE_TYPE_NOT_FOUND = 5078;
        ...
        public const UInt32 ERROR_CLUSTER_RESTYPE_NOT_SUPPORTED = 5079;
        ...
        public const UInt32 ERROR_CLUSTER_RESNAME_NOT_FOUND  = 5080;

        /// <summary>No authentication package could be registered with the RPC server</summary>
        public const UInt32 ERROR_CLUSTER_NO_RPC_PACKAGES_REGISTERED = 5081;
        ...
        public const UInt32 ERROR_CLUSTER_OWNER_NOT_IN_PREFLIST = 5082;
        ...
        public const UInt32 ERROR_CLUSTER_DATABASE_SEQMISMATCH = 5083;
        ...
        */
        ...
        public const UInt32 ERROR_CLUSTER_MEMBERSHIP_INVALID_STATE = 5890;

        /// <summary>The quorum resource does not contain the quorum log</summary>
        public const UInt32 ERROR_CLUSTER_QUORUMLOG_NOT_FOUND = 5891;

        /// <summary>The membership engine requested shutdown of the cluster service on this node</summary>
        public const UInt32 ERROR_CLUSTER_MEMBERSHIP_HALT    = 5892;
        ...
        public const UInt32 ERROR_CLUSTER_EVICT_WITHOUT_CLEANUP = 5896;

        /// <summary>Two or more parameter values specified for a resource's properties are in conflict</summary>
        public const UInt32 ERROR_CLUSTER_PARAMETER_MISMATCH = 5897;

        /// <summary>This computer cannot be made a member of a cluster</summary>
        public const UInt32 ERROR_NODE_CANNOT_BE_CLUSTERED   = 5898;
        ...
        public const UInt32 ERROR_CLUSTER_WRONG_OS_VERSION   = 5899;
        ...
        public const UInt32 ERROR_CLUSTER_CANT_CREATE_DUP_CLUSTER_NAME = 5900;

        /// <summary>The cluster configuration action has already been committed</summary>
        public const UInt32 ERROR_CLUSCFG_ALREADY_COMMITTED  = 5901;

        /// <summary>The cluster configuration action could not be rolled back</summary>
        public const UInt32 ERROR_CLUSCFG_ROLLBACK_FAILED    = 5902;
        ...
        public const UInt32 ERROR_INVALID_CLUSTER_IPV6_ADDRESS = 5911;

        /// <summary>An internal cluster error occurred. A call to an invalid function was attempted</summary>
        public const UInt32 ERROR_CLUSTER_INTERNAL_INVALID_FUNCTION = 5912;

        /// <summary>A parameter value is out of acceptable range</summary>
        public const UInt32 ERROR_CLUSTER_PARAMETER_OUT_OF_BOUNDS = 5913;
        ...
        public const UInt32 ERROR_CLUSTER_PARTIAL_SEND       = 5914;

        /// <summary>An invalid cluster registry operation was attempted</summary>
        public const UInt32 ERROR_CLUSTER_REGISTRY_INVALID_FUNCTION = 5915;

        /// <summary>An input string of characters is not properly terminated</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_STRING_TERMINATION = 5916;

        /// <summary>An input string of characters is not in a valid format for the data it represents</summary>
        public const UInt32 ERROR_CLUSTER_INVALID_STRING_FORMAT = 5917;
        ...
        public const UInt32 ERROR_CLUSTER_DATABASE_TRANSACTION_IN_PROGRESS = 5918;
        ...
        public const UInt32 ERROR_DEPENDENT_RESOURCE_PROPERTY_CONFLICT = 5924;

        /// <summary>A quorum of cluster nodes was not present to form a cluster</summary>
        public const UInt32 ERROR_CLUSTER_NO_QUORUM          = 5925;
        ...
        public const UInt32 ERROR_CLUSTER_INVALID_IPV6_NETWORK = 5926;
        ...
        public const UInt32 ERROR_CLUSTER_INVALID_IPV6_TUNNEL_NETWORK = 5927;

        /// <summary>Quorum resource cannot reside in the Available Storage group</summary>
        public const UInt32 ERROR_QUORUM_NOT_ALLOWED_IN_THIS_GROUP = 5928;

        /// <summary>The dependencies for this resource are nested too deeply</summary>
        public const UInt32 ERROR_DEPENDENCY_TREE_TOO_COMPLEX = 5929;

        /// <summary>The call into the resource DLL raised an unhandled exception</summary>
        public const UInt32 ERROR_EXCEPTION_IN_RESOURCE_CALL = 5930;

        /// <summary>The RHS process failed to initialize</summary>
        public const UInt32 ERROR_CLUSTER_RHS_FAILED_INITIALIZATION = 5931;

        /// <summary>The Failover Clustering feature is not installed on this node</summary>
        public const UInt32 ERROR_CLUSTER_NOT_INSTALLED      = 5932;

        /// <summary>The resources must be online on the same node for this operatio</summary>
        public const UInt32 ERROR_CLUSTER_RESOURCES_MUST_BE_ONLINE_ON_THE_SAME_NODE = 5933;
        ...
        /// <summary>The list of servers for this workgroup is not currently availabl</summary>
        public const UInt32 ERROR_NO_BROWSER_SERVERS_FOUND   = 6118;
        ...
        public const UInt32 SCHED_E_SERVICE_NOT_LOCALSYSTEM  = 6200;
        ...
        public const UInt32 ERROR_LOG_PINNED_RESERVATION     = 6648;
        ...
        public const UInt32 ERROR_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION = 6720;

        /// <summary>The call to create a superior Enlistment on this Transaction object could not be completed, because the Transaction object specified for the enlistment is a subordinate branch of the Transaction.  Only the root of the Transactoin can be enlisted on as a superior</summary>
        public const UInt32 ERROR_TRANSACTION_NOT_ROOT       = 6721;
        ...
        public const UInt32 ERROR_TRANSACTION_OBJECT_EXPIRED = 6722;
        ...
        public const UInt32 ERROR_TRANSACTION_RESPONSE_NOT_ENLISTED = 6723;
        ...
        public const UInt32 ERROR_TRANSACTION_RECORD_TOO_LONG = 6724;

        /// <summary>Implicit transaction are not supported</summary>
        public const UInt32 ERROR_IMPLICIT_TRANSACTION_NOT_SUPPORTED = 6725;
        ...
        public const UInt32 ERROR_TRANSACTION_INTEGRITY_VIOLATED = 6726;
        ...
        public const UInt32 ERROR_TRANSACTIONAL_CONFLICT     = 6800;

        /// <summary>Transaction support within the specified file system resource manager is not started or was shutdown due to an error</summary>
        public const UInt32 ERROR_RM_NOT_ACTIVE              = 6801;

        /// <summary>The metadata of the RM has been corrupted. The RM will not function</summary>
        public const UInt32 ERROR_RM_METADATA_CORRUPT        = 6802;

        /// <summary>The specified directory does not contain a resource manager</summary>
        public const UInt32 ERROR_DIRECTORY_NOT_RM           = 6803;

        /// <summary>The remote server or share does not support transacted file operations</summary>
        public const UInt32 ERROR_TRANSACTIONS_UNSUPPORTED_REMOTE = 6805;

        /// <summary>The requested log size is invalid</summary>
        public const UInt32 ERROR_LOG_RESIZE_INVALID_SIZE    = 6806;
        ...
        public const UInt32 ERROR_OBJECT_NO_LONGER_EXISTS    = 6807;

        /// <summary>The specified file miniversion was not found for this transacted file open</summary>
        public const UInt32 ERROR_STREAM_MINIVERSION_NOT_FOUND = 6808;
        ...
        public const UInt32 ERROR_FILE_IDENTITY_NOT_PERSISTENT = 6823;
        ...
        public const UInt32 ERROR_CANT_BREAK_TRANSACTIONAL_DEPENDENCY = 6824;
        ...
        public const UInt32 ERROR_CANT_CROSS_RM_BOUNDARY     = 6825;

        /// <summary>The $Txf directory must be empty for this operation to succeed</summary>
        public const UInt32 ERROR_TXF_DIR_NOT_EMPTY          = 6826;
        ...
        public const UInt32 ERROR_TRANSACTION_REQUIRED_PROMOTION = 6837;
        ...
        public const UInt32 ERROR_DATA_LOST_REPAIR           = 6843;

        /// <summary>The sparse operation could not be completed because a transaction is active on the file</summary>
        public const UInt32 ERROR_SPARSE_NOT_ALLOWED_IN_TRANSACTION = 6844;
        ...
        public const UInt32 ERROR_TM_IDENTITY_MISMATCH       = 6845;
        ...
        public const UInt32 ERROR_FLOATED_SECTION            = 6846;
        ...
        public const UInt32 ERROR_CANNOT_ACCEPT_TRANSACTED_WORK = 6847;
        ...
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_ERROR   = 7011;
        ...
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_TIMEOUT = 7012;

        /// <summary>Carrier detect has failed or carrier has been dropped due to disconnect</summary>
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_NO_CARRIER = 7013;
        ...
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_NO_DIALTONE = 7014;

        /// <summary>Busy signal detected at remote site on callback</summary>
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_BUSY    = 7015;

        /// <summary>Voice detected at remote site on callback</summary>
        public const UInt32 ERROR_CTX_MODEM_RESPONSE_VOICE   = 7016;

        /// <summary>Transport driver erro</summary>
        public const UInt32 ERROR_CTX_TD_ERROR               = 7017;

        /// <summary>The specified session cannot be found</summary>
        public const UInt32 ERROR_CTX_WINSTATION_NOT_FOUND   = 7022;

        /// <summary>The specified session name is already in use</summary>
        public const UInt32 ERROR_CTX_WINSTATION_ALREADY_EXISTS = 7023;
        ...
        public const UInt32 ERROR_CTX_WINSTATION_BUSY        = 7024;

        /// <summary>An attempt has been made to connect to a session whose video mode is not supported by the current client</summary>
        public const UInt32 ERROR_CTX_BAD_VIDEO_MODE         = 7025;

        /// <summary>The application attempted to enable DOS graphics mode</summary>
        // DOS graphics mode is not supported.
        //
        public const UInt32 ERROR_CTX_GRAPHICS_INVALID       = 7035;

        /// <summary>Your interactive logon privilege has been disabled</summary>
        // Please contact your administrator.
        //
        public const UInt32 ERROR_CTX_LOGON_DISABLED         = 7037;

        /// <summary>The requested operation can be performed only on the system console</summary>
        // This is most often the result of a driver or system DLL requiring direct console access.
        //
        public const UInt32 ERROR_CTX_NOT_CONSOLE            = 7038;

        /// <summary>The client failed to respond to the server connect message</summary>
        public const UInt32 ERROR_CTX_CLIENT_QUERY_TIMEOUT   = 7040;

        /// <summary>Disconnecting the console session is not supported</summary>
        public const UInt32 ERROR_CTX_CONSOLE_DISCONNECT     = 7041;

        /// <summary>Reconnecting a disconnected session to the console is not supported</summary>
        public const UInt32 ERROR_CTX_CONSOLE_CONNECT        = 7042;

        /// <summary>The request to control another session remotely was denied</summary>
        public const UInt32 ERROR_CTX_SHADOW_DENIED          = 7044;

        /// <summary>The requested session access is denied</summary>
        public const UInt32 ERROR_CTX_WINSTATION_ACCESS_DENIED = 7045;

        /// <summary>The specified terminal connection driver is invalid</summary>
        public const UInt32 ERROR_CTX_INVALID_WD             = 7049;

        /// <summary>The requested session cannot be controlled remotely</summary>
        // This may be because the session is disconnected or does not currently have a user logged on.
        //
        public const UInt32 ERROR_CTX_SHADOW_INVALID         = 7050;

        /// <summary>The requested session is not configured to allow remote control</summary>
        public const UInt32 ERROR_CTX_SHADOW_DISABLED        = 7051;

        /// <summary>Your request to connect to this Terminal Server has been rejected. Your Terminal Server client license number is currently being used by another user</summary>
        // Please call your system administrator to obtain a unique license number.
        //
        public const UInt32 ERROR_CTX_CLIENT_LICENSE_IN_USE  = 7052;

        /// <summary>Your request to connect to this Terminal Server has been rejected. Your Terminal Server client license number has not been entered for this copy of the Terminal Server client</summary>
        // Please contact your system administrator.
        //
        public const UInt32 ERROR_CTX_CLIENT_LICENSE_NOT_SET = 7053;

        /// <summary>The number of connections to this computer is limited and all connections are in use right now</summary>
        // Try connecting later or contact your system administrator.
        //
        public const UInt32 ERROR_CTX_LICENSE_NOT_AVAILABLE  = 7054;

        /// <summary>The client you are using is not licensed to use this system. Your logon request is denied</summary>
        public const UInt32 ERROR_CTX_LICENSE_CLIENT_INVALID = 7055;

        /// <summary>The system license has expired. Your logon request is denied</summary>
        public const UInt32 ERROR_CTX_LICENSE_EXPIRED        = 7056;
        ...
        public const UInt32 ERROR_CTX_SHADOW_NOT_RUNNING     = 7057;
        ...
        public const UInt32 ERROR_CTX_SHADOW_ENDED_BY_MODE_CHANGE = 7058;
        ...
        public const UInt32 ERROR_ACTIVATION_COUNT_EXCEEDED  = 7059;

        /// <summary>Remote logins are currently disabled</summary>
        public const UInt32 ERROR_CTX_WINSTATIONS_DISABLED   = 7060;

        /// <summary>You do not have the proper encryption level to access this Session</summary>
        public const UInt32 ERROR_CTX_ENCRYPTION_LEVEL_REQUIRED = 7061;
        ...
        public const UInt32 ERROR_CTX_SESSION_IN_USE         = 7062;
        ...
        public const UInt32 ERROR_CTX_SECURITY_LAYER_ERROR   = 7068;

        /// <summary>The target session is incompatible with the current session</summary>
        public const UInt32 ERROR_TS_INCOMPATIBLE_SESSIONS   = 7069;
        ...
        public const UInt32 FRS_ERR_INVALID_API_SEQUENCE     = 8001;

        /// <summary>The file replication service cannot be started</summary>
        public const UInt32 FRS_ERR_STARTING_SERVICE         = 8002;

        /// <summary>The file replication service cannot be stopped</summary>
        public const UInt32 FRS_ERR_STOPPING_SERVICE         = 8003;

        /// <summary>The file replication service API terminated the request</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_INTERNAL_API             = 8004;

        /// <summary>The file replication service terminated the request</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_INTERNAL                 = 8005;

        /// <summary>The file replication service cannot be contacted</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_SERVICE_COMM             = 8006;

        /// <summary>The file replication service cannot satisfy the request because the user has insufficient privileges</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_INSUFFICIENT_PRIV        = 8007;

        /// <summary>The file replication service cannot satisfy the request because authenticated RPC is not available</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_AUTHENTICATION           = 8008;

        /// <summary>The file replication service cannot satisfy the request because the user has insufficient privileges on the domain controller</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_PARENT_INSUFFICIENT_PRIV = 8009;

        /// <summary>The file replication service cannot satisfy the request because authenticated RPC is not available on the domain controller</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_PARENT_AUTHENTICATION    = 8010;

        /// <summary>The file replication service cannot communicate with the file replication service on the domain controller</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_CHILD_TO_PARENT_COMM     = 8011;

        /// <summary>The file replication service on the domain controller cannot communicate with the file replication service on this computer</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_PARENT_TO_CHILD_COMM     = 8012;

        /// <summary>The file replication service cannot populate the system volume because of an internal error</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_SYSVOL_POPULATE          = 8013;

        /// <summary>The file replication service cannot populate the system volume because of an internal timeout</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_SYSVOL_POPULATE_TIMEOUT  = 8014;
        ...
        public const UInt32 FRS_ERR_SYSVOL_IS_BUSY           = 8015;

        /// <summary>The file replication service cannot stop replicating the system volume because of an internal error</summary>
        // The event log may have more information.
        //
        public const UInt32 FRS_ERR_SYSVOL_DEMOTE            = 8016;

        /// <summary>The file replication service detected an invalid parameter</summary>
        public const UInt32 FRS_ERR_INVALID_SERVICE_PARAMETER = 8017;
        ...
        public const UInt32 ERROR_DS_REFUSING_FSMO_ROLES     = 8433;
        ...
        public const UInt32 ERROR_DS_MISSING_FSMO_SETTINGS   = 8434;
        ...
        public const UInt32 ERROR_DS_DRA_INCOMPATIBLE_PARTIAL_SET = 8464;
        ...
        public const UInt32 ERROR_DS_DRA_SOURCE_IS_PARTIAL_REPLICA = 8465;
        ...
        public const UInt32 ERROR_DS_DRA_EXTN_CONNECTION_FAILED = 8466;
        ...
        public const UInt32 ERROR_DS_BACKLINK_WITHOUT_LINK   = 8482;
        ...
        public const UInt32 ERROR_DS_EPOCH_MISMATCH          = 8483;
        ...
        public const UInt32 ERROR_DS_SRC_NAME_MISMATCH       = 8484;
        ...
        public const UInt32 ERROR_DS_SRC_AND_DST_NC_IDENTICAL = 8485;
        ...
        public const UInt32 ERROR_DS_DST_NC_MISMATCH         = 8486;

        /// <summary>Destination of a cross-domain move is not authoritative for the destination naming context</summary>
        public const UInt32 ERROR_DS_NOT_AUTHORITIVE_FOR_DST_NC = 8487;
        ...
        public const UInt32 ERROR_DS_SRC_GUID_MISMATCH       = 8488;
        ...
        public const UInt32 ERROR_DS_CANT_MOVE_DELETED_OBJECT = 8489;

        /// <summary>Another operation which requires exclusive access to the PDC FSMO is already in progress</summary>
        public const UInt32 ERROR_DS_PDC_OPERATION_IN_PROGRESS = 8490;
        ...
        public const UInt32 ERROR_DS_CROSS_DOMAIN_CLEANUP_REQD = 8491;
        ...
        public const UInt32 ERROR_DS_ILLEGAL_XDOM_MOVE_OPERATION = 8492;
        ...
        public const UInt32 ERROR_DS_CANT_WITH_ACCT_GROUP_MEMBERSHPS = 8493;

        /// <summary>A naming context head must be the immediate child of another naming context head, not of an interior node</summary>
        public const UInt32 ERROR_DS_NC_MUST_HAVE_NC_PARENT  = 8494;
        ...
        public const UInt32 ERROR_DS_CR_IMPOSSIBLE_TO_VALIDATE = 8495;

        /// <summary>Destination domain must be in native mode</summary>
        public const UInt32 ERROR_DS_DST_DOMAIN_NOT_NATIVE   = 8496;
        ...
        public const UInt32 ERROR_DS_MISSING_INFRASTRUCTURE_CONTAINER = 8497;

        /// <summary>Cross-domain move of non-empty account groups is not allowed</summary>
        public const UInt32 ERROR_DS_CANT_MOVE_ACCOUNT_GROUP = 8498;

        /// <summary>Cross-domain move of non-empty resource groups is not allowed</summary>
        public const UInt32 ERROR_DS_CANT_MOVE_RESOURCE_GROUP = 8499;
        ...
        public const UInt32 ERROR_DS_INVALID_SEARCH_FLAG     = 8500;

        /// <summary>Tree deletions starting at an object which has an NC head as a descendant are not allowed</summary>
        public const UInt32 ERROR_DS_NO_TREE_DELETE_ABOVE_NC = 8501;
        ...
        public const UInt32 ERROR_DS_COULDNT_LOCK_TREE_FOR_DELETE = 8502;

        /// <summary>The directory service failed to identify the list of objects to delete while attempting a tree deletion</summary>
        public const UInt32 ERROR_DS_COULDNT_IDENTIFY_OBJECTS_FOR_TREE_DELETE = 8503;
        ...
        public const UInt32 ERROR_DS_NONSAFE_SCHEMA_CHANGE   = 8508;

        /// <summary>Schema update is not allowed on this DC because the DC is not the schema FSMO Role Owner</summary>
        public const UInt32 ERROR_DS_SCHEMA_UPDATE_DISALLOWED = 8509;
        ...
        public const UInt32 ERROR_DS_CANT_CREATE_UNDER_SCHEMA = 8510;
        ...
        public const UInt32 ERROR_DS_INSTALL_NO_SRC_SCH_VERSION = 8511;
        ...
        public const UInt32 ERROR_DS_NAMING_MASTER_GC        = 8523;

        /// <summary>The DSA operation is unable to proceed because of a DNS lookup failure</summary>
        public const UInt32 ERROR_DS_DNS_LOOKUP_FAILURE      = 8524;
        ...
        public const UInt32 ERROR_DS_COULDNT_UPDATE_SPNS     = 8525;

        /// <summary>The Security Descriptor attribute could not be read</summary>
        public const UInt32 ERROR_DS_CANT_RETRIEVE_SD        = 8526;

        /// <summary>The object requested was not found, but an object with that key was found</summary>
        public const UInt32 ERROR_DS_KEY_NOT_UNIQUE          = 8527;

        /// <summary>The syntax of the linked attribute being added is incorrect. Forward links can only have syntax 2.5.5.1, 2.5.5.7, and 2.5.5.14, and backlinks can only have syntax 2.5.5.</summary>
        public const UInt32 ERROR_DS_WRONG_LINKED_ATT_SYNTAX = 8528;

        /// <summary>Security Account Manager needs to get the boot password</summary>
        public const UInt32 ERROR_DS_SAM_NEED_BOOTKEY_PASSWORD = 8529;

        /// <summary>Security Account Manager needs to get the boot key from floppy disk</summary>
        public const UInt32 ERROR_DS_SAM_NEED_BOOTKEY_FLOPPY = 8530;

        /// <summary>Directory Service cannot start</summary>
        public const UInt32 ERROR_DS_CANT_START              = 8531;

        /// <summary>Directory Services could not start</summary>
        public const UInt32 ERROR_DS_INIT_FAILURE            = 8532;

        /// <summary>The connection between client and server requires packet privacy or better</summary>
        public const UInt32 ERROR_DS_NO_PKT_PRIVACY_ON_CONNECTION = 8533;

        /// <summary>The source domain may not be in the same forest as destination</summary>
        public const UInt32 ERROR_DS_SOURCE_DOMAIN_IN_FOREST = 8534;

        /// <summary>The destination domain must be in the forest</summary>
        public const UInt32 ERROR_DS_DESTINATION_DOMAIN_NOT_IN_FOREST = 8535;

        /// <summary>The operation requires that destination domain auditing be enabled</summary>
        public const UInt32 ERROR_DS_DESTINATION_AUDITING_NOT_ENABLED = 8536;

        /// <summary>The operation couldn't locate a DC for the source domain</summary>
        public const UInt32 ERROR_DS_CANT_FIND_DC_FOR_SRC_DOMAIN = 8537;

        /// <summary>The source object must be a group or user</summary>
        public const UInt32 ERROR_DS_SRC_OBJ_NOT_GROUP_OR_USER = 8538;

        /// <summary>The source object's SID already exists in destination forest</summary>
        public const UInt32 ERROR_DS_SRC_SID_EXISTS_IN_FOREST = 8539;

        /// <summary>The source and destination object must be of the same type</summary>
        public const UInt32 ERROR_DS_SRC_AND_DST_OBJECT_CLASS_MISMATCH = 8540;

        /// <summary>Security Accounts Manager initialization failed because of the following error: %1</summary>
        // Error Status: 0x%2. Click OK to shut down the system and reboot into Safe Mode. Check the event log for detailed information.
        //
        public const UInt32 ERROR_SAM_INIT_FAILURE           = 8541;

        /// <summary>Schema information could not be included in the replication request</summary>
        public const UInt32 ERROR_DS_DRA_SCHEMA_INFO_SHIP    = 8542;

        /// <summary>The replication operation could not be completed due to a schema incompatibility</summary>
        public const UInt32 ERROR_DS_DRA_SCHEMA_CONFLICT     = 8543;

        /// <summary>The replication operation could not be completed due to a previous schema incompatibility</summary>
        public const UInt32 ERROR_DS_DRA_EARLIER_SCHEMA_CONFLICT = 8544;
        ...
        public const UInt32 ERROR_DS_DRA_OBJ_NC_MISMATCH     = 8545;
        ...
        public const UInt32 ERROR_DS_NO_CHECKPOINT_WITH_PDC  = 8551;

        /// <summary>The operation requires that source domain auditing be enabled</summary>
        public const UInt32 ERROR_DS_SOURCE_AUDITING_NOT_ENABLED = 8552;

        /// <summary>Security principal objects can only be created inside domain naming contexts</summary>
        public const UInt32 ERROR_DS_CANT_CREATE_IN_NONDOMAIN_NC = 8553;
        ...
        public const UInt32 ERROR_DS_INVALID_NAME_FOR_SPN    = 8554;

        /// <summary>A Filter was passed that uses constructed attributes</summary>
        public const UInt32 ERROR_DS_FILTER_USES_CONTRUCTED_ATTRS = 8555;

        /// <summary>The unicodePwd attribute value must be enclosed in double quotes</summary>
        public const UInt32 ERROR_DS_UNICODEPWD_NOT_IN_QUOTES = 8556;
        ...
        public const UInt32 ERROR_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED = 8557;

        /// <summary>For security reasons, the operation must be run on the destination DC</summary>
        public const UInt32 ERROR_DS_MUST_BE_RUN_ON_DST_DC   = 8558;

        /// <summary>For security reasons, the source DC must be NT4SP4 or greater</summary>
        public const UInt32 ERROR_DS_SRC_DC_MUST_BE_SP4_OR_GREATER = 8559;
        ...
        public const UInt32 ERROR_DS_CANT_TREE_DELETE_CRITICAL_OBJ = 8560;

        /// <summary>Directory Services could not start because of the following error: %1</summary>
        // Error Status: 0x%2. Please click OK to shutdown the system. You can use the recovery console to diagnose the system further.
        //
        public const UInt32 ERROR_DS_INIT_FAILURE_CONSOLE    = 8561;

        /// <summary>Security Accounts Manager initialization failed because of the following error: %1</summary>
        // Error Status: 0x%2. Please click OK to shutdown the system. You can use the recovery console to diagnose the system further.
        //
        public const UInt32 ERROR_DS_SAM_INIT_FAILURE_CONSOLE = 8562;
        ...
        public const UInt32 ERROR_DS_FOREST_VERSION_TOO_HIGH = 8563;
        ...
        public const UInt32 ERROR_DS_DOMAIN_VERSION_TOO_HIGH = 8564;
        ...
        public const UInt32 ERROR_DS_FOREST_VERSION_TOO_LOW  = 8565;
        ...
        public const UInt32 ERROR_DS_DOMAIN_VERSION_TOO_LOW  = 8566;
        ...
        public const UInt32 ERROR_DS_INCOMPATIBLE_VERSION    = 8567;
        ...
        public const UInt32 ERROR_DS_LOW_DSA_VERSION         = 8568;
        ...
        public const UInt32 ERROR_DS_MODIFYDN_WRONG_GRANDPARENT = 8582;

        /// <summary>Unable to resolve completely, a referral to another forest is generated</summary>
        public const UInt32 ERROR_DS_NAME_ERROR_TRUST_REFERRAL = 8583;

        /// <summary>The requested action is not supported on standard server</summary>
        public const UInt32 ERROR_NOT_SUPPORTED_ON_STANDARD_SERVER = 8584;
        ...
        public const UInt32 ERROR_DS_CANT_ACCESS_REMOTE_PART_OF_AD = 8585;
        ...
        public const UInt32 ERROR_DS_CR_IMPOSSIBLE_TO_VALIDATE_V2 = 8586;

        /// <summary>The thread limit for this request was exceeded</summary>
        public const UInt32 ERROR_DS_THREAD_LIMIT_EXCEEDED   = 8587;

        /// <summary>The Global catalog server is not in the closest site</summary>
        public const UInt32 ERROR_DS_NOT_CLOSEST             = 8588;
        ...
        public const UInt32 ERROR_DS_CANT_DERIVE_SPN_WITHOUT_SERVER_REF = 8589;

        /// <summary>The Directory Service failed to enter single user mode</summary>
        public const UInt32 ERROR_DS_SINGLE_USER_MODE_FAILED = 8590;

        /// <summary>The Directory Service cannot parse the script because of a syntax error</summary>
        public const UInt32 ERROR_DS_NTDSCRIPT_SYNTAX_ERROR  = 8591;

        /// <summary>The Directory Service cannot process the script because of an error</summary>
        public const UInt32 ERROR_DS_NTDSCRIPT_PROCESS_ERROR = 8592;

        /// <summary>The directory service cannot perform the requested operation because the server</summary>
        // involved are of different replication epochs (which is usually related to a
        // domain rename that is in progress).
        //
        public const UInt32 ERROR_DS_DIFFERENT_REPL_EPOCHS   = 8593;

        /// <summary>The directory service binding must be renegotiated due to a change in the serve</summary>
        // extensions information.
        //
        public const UInt32 ERROR_DS_DRS_EXTENSIONS_CHANGED  = 8594;

        /// <summary>Operation not allowed on a disabled cross ref</summary>
        public const UInt32 ERROR_DS_REPLICA_SET_CHANGE_NOT_ALLOWED_ON_DISABLED_CR = 8595;

        /// <summary>Schema update failed: No values for msDS-IntId are available</summary>
        public const UInt32 ERROR_DS_NO_MSDS_INTID           = 8596;

        /// <summary>Schema update failed: Duplicate msDS-INtId. Retry the operation</summary>
        public const UInt32 ERROR_DS_DUP_MSDS_INTID          = 8597;

        /// <summary>Schema deletion failed: attribute is used in rDNAttID</summary>
        public const UInt32 ERROR_DS_EXISTS_IN_RDNATTID      = 8598;

        /// <summary>The directory service failed to authorize the request</summary>
        public const UInt32 ERROR_DS_AUTHORIZATION_FAILED    = 8599;

        /// <summary>The Directory Service cannot process the script because it is invalid</summary>
        public const UInt32 ERROR_DS_INVALID_SCRIPT          = 8600;
        ...
        public const UInt32 ERROR_DS_REMOTE_CROSSREF_OP_FAILED = 8601;

        /// <summary>A cross reference is in use locally with the same name</summary>
        public const UInt32 ERROR_DS_CROSS_REF_BUSY          = 8602;
        ...
        public const UInt32 ERROR_DS_CANT_DERIVE_SPN_FOR_DELETED_DOMAIN = 8603;

        /// <summary>Writeable NCs prevent this DC from demoting</summary>
        public const UInt32 ERROR_DS_CANT_DEMOTE_WITH_WRITEABLE_NC = 8604;

        /// <summary>The requested object has a non-unique identifier and cannot be retrieved</summary>
        public const UInt32 ERROR_DS_DUPLICATE_ID_FOUND      = 8605;
        ...
        public const UInt32 ERROR_DS_ROLE_NOT_VERIFIED       = 8610;
        ...
        public const UInt32 ERROR_DS_WKO_CONTAINER_CANNOT_BE_SPECIAL = 8611;
        ...
        public const UInt32 ERROR_DS_DOMAIN_RENAME_IN_PROGRESS = 8612;
        ...
        public const UInt32 ERROR_DS_EXISTING_AD_CHILD_NC    = 8613;
        ...
        public const UInt32 ERROR_DS_REPL_LIFETIME_EXCEEDED  = 8614;

        /// <summary>The requested operation is not allowed on an object under the system container</summary>
        public const UInt32 ERROR_DS_DISALLOWED_IN_SYSTEM_CONTAINER = 8615;
        ...
        public const UInt32 ERROR_DS_LDAP_SEND_QUEUE_FULL    = 8616;
        ...
        public const UInt32 ERROR_DS_DRA_OUT_SCHEDULE_WINDOW = 8617;
        ...
        public const UInt32 ERROR_DS_INVALID_SEARCH_FLAG_SUBTREE = 8626;
        ...
        public const UInt32 ERROR_DS_INVALID_SEARCH_FLAG_TUPLE = 8627;

        /// <summary>The address books are nested too deeply. Failed to build the hierarchy table</summary>
        public const UInt32 ERROR_DS_HIERARCHY_TABLE_TOO_DEEP = 8628;
        ...
        public const UInt32 DNS_INFO_NO_RECORDS              = 9501;

        // DNS_ERROR_BAD_PACKET                  0x0000251e
        /// <summary>Bad DNS packet</summary>
        public const UInt32 DNS_ERROR_BAD_PACKET             = 9502;

        // DNS_ERROR_NO_PACKET                   0x0000251f
        /// <summary>No DNS packet</summary>
        public const UInt32 DNS_ERROR_NO_PACKET              = 9503;

        // DNS_ERROR_RCODE                       0x00002520
        /// <summary>DNS error, check rcode</summary>
        public const UInt32 DNS_ERROR_RCODE                  = 9504;

        // DNS_ERROR_UNSECURE_PACKET             0x00002521
        /// <summary>Unsecured DNS packet</summary>
        public const UInt32 DNS_ERROR_UNSECURE_PACKET        = 9505;
        /// <summary>Unsecured DNS packet</summary>
        public const UInt32 DNS_STATUS_PACKET_UNSECURE       = DNS_ERROR_UNSECURE_PACKET;
        ...
        public const UInt32 DNS_ERROR_NOT_ALLOWED_ON_ROOT_SERVER = 9562;
        ...
        public const UInt32 DNS_ERROR_NOT_ALLOWED_UNDER_DELEGATION = 9563;

        // DNS_ERROR_CANNOT_FIND_ROOT_HINTS  0x0000255C
        /// <summary>The DNS server could not find a set of root hints</summary>
        public const UInt32 DNS_ERROR_CANNOT_FIND_ROOT_HINTS = 9564;
        ...
        public const UInt32 DNS_ERROR_BACKGROUND_LOADING     = 9568;
        ...
        public const UInt32 DNS_ERROR_ZONE_DOES_NOT_EXIST    = 9601;

        // DNS_ERROR_NO_ZONE_INFO                0x00002582
        /// <summary>DNS zone information not available</summary>
        public const UInt32 DNS_ERROR_NO_ZONE_INFO           = 9602;

        // DNS_ERROR_INVALID_ZONE_OPERATION      0x00002583
        /// <summary>Invalid operation for DNS zone</summary>
        public const UInt32 DNS_ERROR_INVALID_ZONE_OPERATION = 9603;

        // DNS_ERROR_ZONE_CONFIGURATION_ERROR    0x00002584
        /// <summary>Invalid DNS zone configuration</summary>
        public const UInt32 DNS_ERROR_ZONE_CONFIGURATION_ERROR = 9604;

        // DNS_ERROR_ZONE_HAS_NO_SOA_RECORD      0x00002585
        /// <summary>DNS zone has no start of authority (SOA) record</summary>
        public const UInt32 DNS_ERROR_ZONE_HAS_NO_SOA_RECORD = 9605;

        // DNS_ERROR_ZONE_HAS_NO_NS_RECORDS      0x00002586
        /// <summary>DNS zone has no Name Server (NS) record</summary>
        public const UInt32 DNS_ERROR_ZONE_HAS_NO_NS_RECORDS = 9606;

        // DNS_ERROR_ZONE_LOCKED                 0x00002587
        /// <summary>DNS zone is locked</summary>
        public const UInt32 DNS_ERROR_ZONE_LOCKED            = 9607;

        // DNS_ERROR_ZONE_CREATION_FAILED        0x00002588
        /// <summary>DNS zone creation failed</summary>
        public const UInt32 DNS_ERROR_ZONE_CREATION_FAILED   = 9608;

        // DNS_ERROR_ZONE_ALREADY_EXISTS         0x00002589
        /// <summary>DNS zone already exists</summary>
        public const UInt32 DNS_ERROR_ZONE_ALREADY_EXISTS    = 9609;

        // DNS_ERROR_AUTOZONE_ALREADY_EXISTS     0x0000258a
        /// <summary>DNS automatic zone already exists</summary>
        public const UInt32 DNS_ERROR_AUTOZONE_ALREADY_EXISTS = 9610;

        // DNS_ERROR_INVALID_ZONE_TYPE           0x0000258b
        /// <summary>Invalid DNS zone type</summary>
        public const UInt32 DNS_ERROR_INVALID_ZONE_TYPE      = 9611;

        // DNS_ERROR_SECONDARY_REQUIRES_MASTER_IP 0x0000258c
        /// <summary>Secondary DNS zone requires master IP address</summary>
        public const UInt32 DNS_ERROR_SECONDARY_REQUIRES_MASTER_IP = 9612;

        // DNS_ERROR_ZONE_NOT_SECONDARY          0x0000258d
        /// <summary>DNS zone not secondary</summary>
        public const UInt32 DNS_ERROR_ZONE_NOT_SECONDARY     = 9613;

        // DNS_ERROR_NEED_SECONDARY_ADDRESSES    0x0000258e
        /// <summary>Need secondary IP address</summary>
        public const UInt32 DNS_ERROR_NEED_SECONDARY_ADDRESSES = 9614;

        // DNS_ERROR_WINS_INIT_FAILED            0x0000258f
        /// <summary>WINS initialization failed</summary>
        public const UInt32 DNS_ERROR_WINS_INIT_FAILED       = 9615;

        // DNS_ERROR_NEED_WINS_SERVERS           0x00002590
        /// <summary>Need WINS servers</summary>
        public const UInt32 DNS_ERROR_NEED_WINS_SERVERS      = 9616;

        // DNS_ERROR_NBSTAT_INIT_FAILED          0x00002591
        /// <summary>NBTSTAT initialization call failed</summary>
        public const UInt32 DNS_ERROR_NBSTAT_INIT_FAILED     = 9617;

        // DNS_ERROR_SOA_DELETE_INVALID          0x00002592
        /// <summary>Invalid delete of start of authority (SOA</summary>
        public const UInt32 DNS_ERROR_SOA_DELETE_INVALID     = 9618;

        // DNS_ERROR_FORWARDER_ALREADY_EXISTS    0x00002593
        /// <summary>A conditional forwarding zone already exists for that name</summary>
        public const UInt32 DNS_ERROR_FORWARDER_ALREADY_EXISTS = 9619;
        ...
        public const UInt32 DNS_ERROR_ZONE_REQUIRES_MASTER_IP = 9620;

        // DNS_ERROR_ZONE_IS_SHUTDOWN            0x00002595
        /// <summary>The operation cannot be performed because this zone is shutdown</summary>
        public const UInt32 DNS_ERROR_ZONE_IS_SHUTDOWN       = 9621;
        ...
        public const UInt32 DNS_ERROR_PRIMARY_REQUIRES_DATAFILE = 9651;

        // DNS                                   0x000025b4
        /// <summary>Invalid datafile name for DNS zone</summary>
        public const UInt32 DNS_ERROR_INVALID_DATAFILE_NAME  = 9652;

        // DNS                                   0x000025b5
        /// <summary>Failed to open datafile for DNS zone</summary>
        public const UInt32 DNS_ERROR_DATAFILE_OPEN_FAILURE  = 9653;

        // DNS                                   0x000025b6
        /// <summary>Failed to write datafile for DNS zone</summary>
        public const UInt32 DNS_ERROR_FILE_WRITEBACK_FAILED  = 9654;

        // DNS                                   0x000025b7
        /// <summary>Failure while reading datafile for DNS zone</summary>
        public const UInt32 DNS_ERROR_DATAFILE_PARSING       = 9655;
        ...
        public const UInt32 DNS_INFO_AXFR_COMPLETE           = 9751;

        // DNS_ERROR_AXFR                        0x00002618
        /// <summary>DNS zone transfer failed</summary>
        public const UInt32 DNS_ERROR_AXFR                   = 9752;

        // DNS_INFO_ADDED_LOCAL_WINS             0x00002619
        /// <summary>Added local WINS server</summary>
        public const UInt32 DNS_INFO_ADDED_LOCAL_WINS        = 9753;
        ...
        public const UInt32 DNS_STATUS_CONTINUE_NEEDED       = 9801;
        ...
        public const UInt32 DNS_ERROR_NO_TCPIP               = 9851;

        // DNS_ERROR_NO_DNS_SERVERS              0x0000267c
        /// <summary>No DNS servers configured for local system</summary>
        public const UInt32 DNS_ERROR_NO_DNS_SERVERS         = 9852;
        ...
        public const UInt32 DNS_ERROR_DP_NOT_AVAILABLE       = 9905;
        ...
        public const UInt32 DNS_ERROR_DP_FSMO_ERROR          = 9906;
        ...
        public const UInt32 WSAEMSGSIZE                      = 10040;
        ...
        public const UInt32 WSAENOTCONN                      = 10057;
        ...
        public const UInt32 WSAESHUTDOWN                     = 10058;

        /// <summary>Too many references to some kernel object</summary>
        public const UInt32 WSAETOOMANYREFS                  = 10059;
        ...
        public const UInt32 WSAEPROCLIM                      = 10067;

        /// <summary>Ran out of quota</summary>
        public const UInt32 WSAEUSERS                        = 10068;

        /// <summary>Ran out of disk quota</summary>
        public const UInt32 WSAEDQUOT                        = 10069;

        /// <summary>File handle reference is no longer available</summary>
        public const UInt32 WSAESTALE                        = 10070;

        /// <summary>Item is not available locally</summary>
        public const UInt32 WSAEREMOTE                       = 10071;
        ...
        public const UInt32 ERROR_IPSEC_QM_POLICY_EXISTS     = 13000;

        /// <summary>The specified quick mode policy was not found</summary>
        public const UInt32 ERROR_IPSEC_QM_POLICY_NOT_FOUND  = 13001;

        /// <summary>The specified quick mode policy is being used</summary>
        public const UInt32 ERROR_IPSEC_QM_POLICY_IN_USE     = 13002;

        /// <summary>The specified main mode policy already exists</summary>
        public const UInt32 ERROR_IPSEC_MM_POLICY_EXISTS     = 13003;

        /// <summary>The specified main mode policy was not foun</summary>
        public const UInt32 ERROR_IPSEC_MM_POLICY_NOT_FOUND  = 13004;

        /// <summary>The specified main mode policy is being used</summary>
        public const UInt32 ERROR_IPSEC_MM_POLICY_IN_USE     = 13005;

        /// <summary>The specified main mode filter already exists</summary>
        public const UInt32 ERROR_IPSEC_MM_FILTER_EXISTS     = 13006;

        /// <summary>The specified main mode filter was not found</summary>
        public const UInt32 ERROR_IPSEC_MM_FILTER_NOT_FOUND  = 13007;

        /// <summary>The specified transport mode filter already exists</summary>
        public const UInt32 ERROR_IPSEC_TRANSPORT_FILTER_EXISTS = 13008;

        /// <summary>The specified transport mode filter does not exist</summary>
        public const UInt32 ERROR_IPSEC_TRANSPORT_FILTER_NOT_FOUND = 13009;

        /// <summary>The specified main mode authentication list exists</summary>
        public const UInt32 ERROR_IPSEC_MM_AUTH_EXISTS       = 13010;

        /// <summary>The specified main mode authentication list was not found</summary>
        public const UInt32 ERROR_IPSEC_MM_AUTH_NOT_FOUND    = 13011;

        /// <summary>The specified main mode authentication list is being used</summary>
        public const UInt32 ERROR_IPSEC_MM_AUTH_IN_USE       = 13012;

        /// <summary>The specified default main mode policy was not found</summary>
        public const UInt32 ERROR_IPSEC_DEFAULT_MM_POLICY_NOT_FOUND = 13013;

        /// <summary>The specified default main mode authentication list was not found</summary>
        public const UInt32 ERROR_IPSEC_DEFAULT_MM_AUTH_NOT_FOUND = 13014;

        /// <summary>The specified default quick mode policy was not found</summary>
        public const UInt32 ERROR_IPSEC_DEFAULT_QM_POLICY_NOT_FOUND = 13015;

        /// <summary>The specified tunnel mode filter exists</summary>
        public const UInt32 ERROR_IPSEC_TUNNEL_FILTER_EXISTS = 13016;

        /// <summary>The specified tunnel mode filter was not found</summary>
        public const UInt32 ERROR_IPSEC_TUNNEL_FILTER_NOT_FOUND = 13017;

        /// <summary>The Main Mode filter is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_MM_FILTER_PENDING_DELETION = 13018;

        /// <summary>The transport filter is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_TRANSPORT_FILTER_PENDING_DELETION = 13019;

        /// <summary>The tunnel filter is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_TUNNEL_FILTER_PENDING_DELETION = 13020;

        /// <summary>The Main Mode policy is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_MM_POLICY_PENDING_DELETION = 13021;

        /// <summary>The Main Mode authentication bundle is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_MM_AUTH_PENDING_DELETION = 13022;

        /// <summary>The Quick Mode policy is pending deletion</summary>
        public const UInt32 ERROR_IPSEC_QM_POLICY_PENDING_DELETION = 13023;

        /// <summary>The Main Mode policy was successfully added, but some of the requested offers are not supported</summary>
        public const UInt32 WARNING_IPSEC_MM_POLICY_PRUNED   = 13024;

        /// <summary>The Quick Mode policy was successfully added, but some of the requested offers are not supported</summary>
        public const UInt32 WARNING_IPSEC_QM_POLICY_PRUNED   = 13025;

        /// <summary> ERROR_IPSEC_IKE_NEG_STATUS_BEGI</summary>
        public const UInt32 ERROR_IPSEC_IKE_NEG_STATUS_BEGIN = 13800;

        /// <summary>IKE authentication credentials are unacceptabl</summary>
        public const UInt32 ERROR_IPSEC_IKE_AUTH_FAIL        = 13801;

        /// <summary>IKE security attributes are unacceptabl</summary>
        public const UInt32 ERROR_IPSEC_IKE_ATTRIB_FAIL      = 13802;

        /// <summary>IKE Negotiation in progres</summary>
        public const UInt32 ERROR_IPSEC_IKE_NEGOTIATION_PENDING = 13803;

        /// <summary>General processing erro</summary>
        public const UInt32 ERROR_IPSEC_IKE_GENERAL_PROCESSING_ERROR = 13804;

        /// <summary>Negotiation timed ou</summary>
        public const UInt32 ERROR_IPSEC_IKE_TIMED_OUT        = 13805;
        ...
        public const UInt32 ERROR_IPSEC_IKE_NO_CERT          = 13806;

        /// <summary>IKE SA deleted by peer before establishment complete</summary>
        public const UInt32 ERROR_IPSEC_IKE_SA_DELETED       = 13807;

        /// <summary>IKE SA deleted before establishment complete</summary>
        public const UInt32 ERROR_IPSEC_IKE_SA_REAPED        = 13808;

        /// <summary>Negotiation request sat in Queue too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_MM_ACQUIRE_DROP  = 13809;

        /// <summary>Negotiation request sat in Queue too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_QM_ACQUIRE_DROP  = 13810;

        /// <summary>Negotiation request sat in Queue too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_QUEUE_DROP_MM    = 13811;

        /// <summary>Negotiation request sat in Queue too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_QUEUE_DROP_NO_MM = 13812;

        /// <summary>No response from peer</summary>
        public const UInt32 ERROR_IPSEC_IKE_DROP_NO_RESPONSE = 13813;

        /// <summary>Negotiation took too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_MM_DELAY_DROP    = 13814;

        /// <summary>Negotiation took too lon</summary>
        public const UInt32 ERROR_IPSEC_IKE_QM_DELAY_DROP    = 13815;

        /// <summary>Unknown error occurre</summary>
        public const UInt32 ERROR_IPSEC_IKE_ERROR            = 13816;

        /// <summary>Certificate Revocation Check faile</summary>
        public const UInt32 ERROR_IPSEC_IKE_CRL_FAILED       = 13817;

        /// <summary>Invalid certificate key usag</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_KEY_USAGE = 13818;

        /// <summary>Invalid certificate typ</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_CERT_TYPE = 13819;
        ...
        public const UInt32 ERROR_IPSEC_IKE_NO_PRIVATE_KEY   = 13820;

        /// <summary>Failure in Diffie-Helman computatio</summary>
        public const UInt32 ERROR_IPSEC_IKE_DH_FAIL          = 13822;

        /// <summary>Invalid heade</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_HEADER   = 13824;

        /// <summary>No policy configure</summary>
        public const UInt32 ERROR_IPSEC_IKE_NO_POLICY        = 13825;

        /// <summary>Failed to verify signatur</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_SIGNATURE = 13826;

        /// <summary>Failed to authenticate using kerbero</summary>
        public const UInt32 ERROR_IPSEC_IKE_KERBEROS_ERROR   = 13827;

        /// <summary>Peer's certificate did not have a public ke</summary>
        public const UInt32 ERROR_IPSEC_IKE_NO_PUBLIC_KEY    = 13828;

        // These must stay as a unit.
        /// <summary>Error processing error payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR      = 13829;

        /// <summary>Error processing SA payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_SA   = 13830;

        /// <summary>Error processing Proposal payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_PROP = 13831;

        /// <summary>Error processing Transform payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_TRANS = 13832;

        /// <summary>Error processing KE payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_KE   = 13833;

        /// <summary>Error processing ID payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_ID   = 13834;

        /// <summary>Error processing Cert payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_CERT = 13835;

        /// <summary>Error processing Certificate Request payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_CERT_REQ = 13836;

        /// <summary>Error processing Hash payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_HASH = 13837;

        /// <summary>Error processing Signature payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_SIG  = 13838;

        /// <summary>Error processing Nonce payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_NONCE = 13839;

        /// <summary>Error processing Notify payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_NOTIFY = 13840;

        /// <summary>Error processing Delete Payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_DELETE = 13841;

        /// <summary>Error processing VendorId payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_PROCESS_ERR_VENDOR = 13842;

        /// <summary>Invalid payload receive</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_PAYLOAD  = 13843;

        /// <summary>Soft SA loade</summary>
        public const UInt32 ERROR_IPSEC_IKE_LOAD_SOFT_SA     = 13844;

        /// <summary>Soft SA torn dow</summary>
        public const UInt32 ERROR_IPSEC_IKE_SOFT_SA_TORN_DOWN = 13845;

        /// <summary>Invalid cookie received</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_COOKIE   = 13846;

        /// <summary>Peer failed to send valid machine certificat</summary>
        public const UInt32 ERROR_IPSEC_IKE_NO_PEER_CERT     = 13847;

        /// <summary>Certification Revocation check of peer's certificate faile</summary>
        public const UInt32 ERROR_IPSEC_IKE_PEER_CRL_FAILED  = 13848;

        /// <summary>New policy invalidated SAs formed with old polic</summary>
        public const UInt32 ERROR_IPSEC_IKE_POLICY_CHANGE    = 13849;

        /// <summary>There is no available Main Mode IKE policy</summary>
        public const UInt32 ERROR_IPSEC_IKE_NO_MM_POLICY     = 13850;

        /// <summary>Failed to enabled TCB privilege</summary>
        public const UInt32 ERROR_IPSEC_IKE_NOTCBPRIV        = 13851;

        /// <summary>Failed to load SECURITY.DLL</summary>
        public const UInt32 ERROR_IPSEC_IKE_SECLOADFAIL      = 13852;

        /// <summary>Failed to obtain security function table dispatch address from SSPI</summary>
        public const UInt32 ERROR_IPSEC_IKE_FAILSSPINIT      = 13853;

        /// <summary>Failed to query Kerberos package to obtain max token size</summary>
        public const UInt32 ERROR_IPSEC_IKE_FAILQUERYSSP     = 13854;
        ...
        public const UInt32 ERROR_IPSEC_IKE_GETSPIFAIL       = 13857;

        /// <summary>Given filter is invali</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_FILTER   = 13858;

        /// <summary>Memory allocation failed</summary>
        public const UInt32 ERROR_IPSEC_IKE_OUT_OF_MEMORY    = 13859;
        ...
        public const UInt32 ERROR_IPSEC_IKE_ADD_UPDATE_KEY_FAILED = 13860;

        /// <summary>Invalid polic</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_POLICY   = 13861;

        /// <summary>Invalid DO</summary>
        public const UInt32 ERROR_IPSEC_IKE_UNKNOWN_DOI      = 13862;

        /// <summary>Invalid situatio</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_SITUATION = 13863;

        /// <summary>Diffie-Hellman failur</summary>
        public const UInt32 ERROR_IPSEC_IKE_DH_FAILURE       = 13864;

        /// <summary>Invalid Diffie-Hellman grou</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_GROUP    = 13865;

        /// <summary>Error encrypting payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_ENCRYPT          = 13866;

        /// <summary>Error decrypting payloa</summary>
        public const UInt32 ERROR_IPSEC_IKE_DECRYPT          = 13867;

        /// <summary>Policy match erro</summary>
        public const UInt32 ERROR_IPSEC_IKE_POLICY_MATCH     = 13868;

        /// <summary>Unsupported I</summary>
        public const UInt32 ERROR_IPSEC_IKE_UNSUPPORTED_ID   = 13869;

        /// <summary>Hash verification faile</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_HASH     = 13870;

        /// <summary>Invalid hash algorith</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_HASH_ALG = 13871;

        /// <summary>Invalid hash siz</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_HASH_SIZE = 13872;

        /// <summary>Invalid encryption algorith</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_ENCRYPT_ALG = 13873;

        /// <summary>Invalid authentication algorith</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_AUTH_ALG = 13874;

        /// <summary>Invalid certificate signatur</summary>
        public const UInt32 ERROR_IPSEC_IKE_INVALID_SIG      = 13875;

        /// <summary>Load faile</summary>
        public const UInt32 ERROR_IPSEC_IKE_LOAD_FAILED      = 13876;

        /// <summary>Deleted via RPC cal</summary>
        public const UInt32 ERROR_IPSEC_IKE_RPC_DELETE       = 13877;

        /// <summary>Temporary state created to perform reinit. This is not a real failure</summary>
        public const UInt32 ERROR_IPSEC_IKE_BENIGN_REINIT    = 13878;
        ...
        public const UInt32 ERROR_SXS_SECTION_NOT_FOUND      = 14000;

        /// <summary>The application has failed to start because its side-by-side configuration is incorrect. Please see the application event log for more detail</summary>
        public const UInt32 ERROR_SXS_CANT_GEN_ACTCTX        = 14001;

        /// <summary>The application binding data format is invalid</summary>
        public const UInt32 ERROR_SXS_INVALID_ACTCTXDATA_FORMAT = 14002;

        /// <summary>The referenced assembly is not installed on your system</summary>
        public const UInt32 ERROR_SXS_ASSEMBLY_NOT_FOUND     = 14003;

        /// <summary>The manifest file does not begin with the required tag and format information</summary>
        public const UInt32 ERROR_SXS_MANIFEST_FORMAT_ERROR  = 14004;

        /// <summary>The manifest file contains one or more syntax errors</summary>
        public const UInt32 ERROR_SXS_MANIFEST_PARSE_ERROR   = 14005;

        /// <summary>The application attempted to activate a disabled activation context</summary>
        public const UInt32 ERROR_SXS_ACTIVATION_CONTEXT_DISABLED = 14006;

        /// <summary>The requested lookup key was not found in any active activation context</summary>
        public const UInt32 ERROR_SXS_KEY_NOT_FOUND          = 14007;

        /// <summary>A component version required by the application conflicts with another component version already active</summary>
        public const UInt32 ERROR_SXS_VERSION_CONFLICT       = 14008;

        /// <summary>The type requested activation context section does not match the query API used</summary>
        public const UInt32 ERROR_SXS_WRONG_SECTION_TYPE     = 14009;
        ...
        public const UInt32 ERROR_SXS_THREAD_QUERIES_DISABLED = 14010;
        ...
        public const UInt32 ERROR_SXS_UNKNOWN_ENCODING_GROUP = 14012;

        /// <summary>The encoding requested is not recognized</summary>
        public const UInt32 ERROR_SXS_UNKNOWN_ENCODING       = 14013;

        /// <summary>The manifest contains a reference to an invalid URI</summary>
        public const UInt32 ERROR_SXS_INVALID_XML_NAMESPACE_URI = 14014;

        /// <summary>The application manifest contains a reference to a dependent assembly which is not installe</summary>
        public const UInt32 ERROR_SXS_ROOT_MANIFEST_DEPENDENCY_NOT_INSTALLED = 14015;

        /// <summary>The manifest for an assembly used by the application has a reference to a dependent assembly which is not installe</summary>
        public const UInt32 ERROR_SXS_LEAF_MANIFEST_DEPENDENCY_NOT_INSTALLED = 14016;

        /// <summary>The manifest contains an attribute for the assembly identity which is not valid</summary>
        public const UInt32 ERROR_SXS_INVALID_ASSEMBLY_IDENTITY_ATTRIBUTE = 14017;

        /// <summary>The manifest is missing the required default namespace specification on the assembly element</summary>
        public const UInt32 ERROR_SXS_MANIFEST_MISSING_REQUIRED_DEFAULT_NAMESPACE = 14018;
        ...
        public const UInt32 ERROR_SXS_MANIFEST_INVALID_REQUIRED_DEFAULT_NAMESPACE = 14019;

        /// <summary>The private manifest probed has crossed reparse-point-associated pat</summary>
        public const UInt32 ERROR_SXS_PRIVATE_MANIFEST_CROSS_PATH_WITH_REPARSE_POINT = 14020;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_DLL_NAME     = 14021;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_WINDOWCLASS_NAME = 14022;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_CLSID        = 14023;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_IID          = 14024;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_TLBID        = 14025;
        ...
        public const UInt32 ERROR_SXS_DUPLICATE_PROGID       = 14026;
        ...
        public const UInt32 ERROR_SXS_IDENTITY_PARSE_ERROR   = 14093;

        /// <summary>A string containing localized substitutable content was malformed. Either a dollar sign ($) was follwed by something other than a left parenthesis or another dollar sign or an substitution's right parenthesis was not found</summary>
        public const UInt32 ERROR_MALFORMED_SUBSTITUTION_STRING = 14094;

        /// <summary>The public key token does not correspond to the public key specified</summary>
        public const UInt32 ERROR_SXS_INCORRECT_PUBLIC_KEY_TOKEN = 14095;

        /// <summary>A substitution string had no mapping</summary>
        public const UInt32 ERROR_UNMAPPED_SUBSTITUTION_STRING = 14096;

        /// <summary>The component must be locked before making the request</summary>
        public const UInt32 ERROR_SXS_ASSEMBLY_NOT_LOCKED    = 14097;

        /// <summary>The component store has been corrupted</summary>
        public const UInt32 ERROR_SXS_COMPONENT_STORE_CORRUPT = 14098;

        /// <summary>An advanced installer failed during setup or servicing</summary>
        public const UInt32 ERROR_ADVANCED_INSTALLER_FAILED  = 14099;

        /// <summary>The character encoding in the XML declaration did not match the encoding used in the document</summary>
        public const UInt32 ERROR_XML_ENCODING_MISMATCH      = 14100;

        /// <summary>The identities of the manifests are identical but their contents are different</summary>
        public const UInt32 ERROR_SXS_MANIFEST_IDENTITY_SAME_BUT_CONTENTS_DIFFERENT = 14101;

        /// <summary>The component identities are different</summary>
        public const UInt32 ERROR_SXS_IDENTITIES_DIFFERENT   = 14102;

        /// <summary>The assembly is not a deployment</summary>
        public const UInt32 ERROR_SXS_ASSEMBLY_IS_NOT_A_DEPLOYMENT = 14103;

        /// <summary>The file is not a part of the assembly</summary>
        public const UInt32 ERROR_SXS_FILE_NOT_PART_OF_ASSEMBLY = 14104;

        /// <summary>The size of the manifest exceeds the maximum allowed</summary>
        public const UInt32 ERROR_SXS_MANIFEST_TOO_BIG       = 14105;

        /// <summary>The setting is not registered</summary>
        public const UInt32 ERROR_SXS_SETTING_NOT_REGISTERED = 14106;

        /// <summary>One or more required members of the transaction are not present</summary>
        public const UInt32 ERROR_SXS_TRANSACTION_CLOSURE_INCOMPLETE = 14107;

        /// <summary>The SMI primitive installer failed during setup or servicing</summary>
        public const UInt32 ERROR_SMI_PRIMITIVE_INSTALLER_FAILED = 14108;

        /// <summary>A generic command executable returned a result that indicates failure</summary>
        public const UInt32 ERROR_GENERIC_COMMAND_FAILED     = 14109;

        /// <summary>A component is missing file verification information in its manifest</summary>
        public const UInt32 ERROR_SXS_FILE_HASH_MISSING      = 14110;
        ...
        public const UInt32 ERROR_EVT_INVALID_CHANNEL_PATH   = 15000;

        /// <summary>The specified query is invalid</summary>
        public const UInt32 ERROR_EVT_INVALID_QUERY          = 15001;

        /// <summary>The publisher metadata cannot be found in the resource</summary>
        public const UInt32 ERROR_EVT_PUBLISHER_METADATA_NOT_FOUND = 15002;

        /// <summary>The template for an event definition cannot be found in the resource (error = %1)</summary>
        public const UInt32 ERROR_EVT_EVENT_TEMPLATE_NOT_FOUND = 15003;

        /// <summary>The specified publisher name is invalid</summary>
        public const UInt32 ERROR_EVT_INVALID_PUBLISHER_NAME = 15004;

        /// <summary>The event data raised by the publisher is not compatible with the event template definition in the publisher's manifes</summary>
        public const UInt32 ERROR_EVT_INVALID_EVENT_DATA     = 15005;

        /// <summary>The specified channel could not be found. Check channel configuration</summary>
        public const UInt32 ERROR_EVT_CHANNEL_NOT_FOUND      = 15007;

        /// <summary>The specified xml text was not well-formed. See Extended Error for more details</summary>
        public const UInt32 ERROR_EVT_MALFORMED_XML_TEXT     = 15008;
        ...
        public const UInt32 ERROR_EVT_SUBSCRIPTION_TO_DIRECT_CHANNEL = 15009;

        /// <summary>Configuration error</summary>
        public const UInt32 ERROR_EVT_CONFIGURATION_ERROR    = 15010;
        ...
        public const UInt32 ERROR_EVT_QUERY_RESULT_STALE     = 15011;

        /// <summary>Query result is currently at an invalid position</summary>
        public const UInt32 ERROR_EVT_QUERY_RESULT_INVALID_POSITION = 15012;

        /// <summary>Registered MSXML doesn't support validation</summary>
        public const UInt32 ERROR_EVT_NON_VALIDATING_MSXML   = 15013;
        ...
        public const UInt32 ERROR_EVT_FILTER_ALREADYSCOPED   = 15014;

        /// <summary>Can't perform a step operation from a term that does not represent an element set</summary>
        public const UInt32 ERROR_EVT_FILTER_NOTELTSET       = 15015;
        ...
        public const UInt32 ERROR_EVT_FILTER_INVARG          = 15016;
        ...
        public const UInt32 ERROR_EVT_FILTER_INVTEST         = 15017;

        /// <summary>This data type is currently unsupported</summary>
        public const UInt32 ERROR_EVT_FILTER_INVTYPE         = 15018;

        /// <summary>A syntax error occurred at position %1!d</summary>
        public const UInt32 ERROR_EVT_FILTER_PARSEERR        = 15019;

        /// <summary>This operator is unsupported by this implementation of the filter</summary>
        public const UInt32 ERROR_EVT_FILTER_UNSUPPORTEDOP   = 15020;

        /// <summary>The token encountered was unexpected</summary>
        public const UInt32 ERROR_EVT_FILTER_UNEXPECTEDTOKEN = 15021;
        ...
        public const UInt32 ERROR_EVT_INVALID_OPERATION_OVER_ENABLED_DIRECT_CHANNEL = 15022;
        ...
        public const UInt32 ERROR_EVT_INVALID_CHANNEL_PROPERTY_VALUE = 15023;
        ...
        public const UInt32 ERROR_EVT_INVALID_PUBLISHER_PROPERTY_VALUE = 15024;

        /// <summary>The channel fails to activate</summary>
        public const UInt32 ERROR_EVT_CHANNEL_CANNOT_ACTIVATE = 15025;
        ...
        public const UInt32 ERROR_EVT_FILTER_TOO_COMPLEX     = 15026;

        /// <summary>the message resource is present but the message is not found in the string/message tabl</summary>
        public const UInt32 ERROR_EVT_MESSAGE_NOT_FOUND      = 15027;

        /// <summary>The message id for the desired message could not be found</summary>
        public const UInt32 ERROR_EVT_MESSAGE_ID_NOT_FOUND   = 15028;

        /// <summary>The substitution string for insert index (%1) could not be found</summary>
        public const UInt32 ERROR_EVT_UNRESOLVED_VALUE_INSERT = 15029;

        /// <summary>The description string for parameter reference (%1) could not be found</summary>
        public const UInt32 ERROR_EVT_UNRESOLVED_PARAMETER_INSERT = 15030;

        /// <summary>The maximum number of replacements has been reached</summary>
        public const UInt32 ERROR_EVT_MAX_INSERTS_REACHED    = 15031;

        /// <summary>The event definition could not be found for event id (%1)</summary>
        public const UInt32 ERROR_EVT_EVENT_DEFINITION_NOT_FOUND = 15032;

        /// <summary>The locale specific resource for the desired message is not present</summary>
        public const UInt32 ERROR_EVT_MESSAGE_LOCALE_NOT_FOUND = 15033;

        /// <summary>The resource is too old to be compatible</summary>
        public const UInt32 ERROR_EVT_VERSION_TOO_OLD        = 15034;

        /// <summary>The resource is too new to be compatible</summary>
        public const UInt32 ERROR_EVT_VERSION_TOO_NEW        = 15035;

        /// <summary>The channel at index %1!d! of the query can't be opened</summary>
        public const UInt32 ERROR_EVT_CANNOT_OPEN_CHANNEL_OF_QUERY = 15036;

        /// <summary>The publisher has been disabled and its resource is not avaiable.  Thi</summary>
        // usually occurs when the publisher is in the process of being uninstalled
        // or upgraded.
        //
        public const UInt32 ERROR_EVT_PUBLISHER_DISABLED     = 15037;

        /// <summary>Attempted to create a numeric type that is outside of its valid range</summary>
        public const UInt32 ERROR_EVT_FILTER_OUT_OF_RANGE    = 15038;
        ...
        public const UInt32 ERROR_EC_SUBSCRIPTION_CANNOT_ACTIVATE = 15080;
        ...
        public const UInt32 ERROR_EC_LOG_DISABLED            = 15081;
        ...
        public const UInt32 ERROR_MUI_FILE_NOT_FOUND         = 15100;

        /// <summary>The resource loader failed to load MUI file because the file fail to pass validation</summary>
        public const UInt32 ERROR_MUI_INVALID_FILE           = 15101;

        /// <summary>The RC Manifest is corrupted with garbage data or unsupported version or missing required item</summary>
        public const UInt32 ERROR_MUI_INVALID_RC_CONFIG      = 15102;

        /// <summary>The RC Manifest has invalid culture name</summary>
        public const UInt32 ERROR_MUI_INVALID_LOCALE_NAME    = 15103;

        /// <summary>The RC Manifest has invalid ultimatefallback name</summary>
        public const UInt32 ERROR_MUI_INVALID_ULTIMATEFALLBACK_NAME = 15104;

        /// <summary>The resource loader cache doesn't have loaded MUI entry</summary>
        public const UInt32 ERROR_MUI_FILE_NOT_LOADED        = 15105;

        /// <summary>User stopped resource enumeration</summary>
        public const UInt32 ERROR_RESOURCE_ENUM_USER_STOP    = 15106;

        /// <summary>UI language installation failed</summary>
        public const UInt32 ERROR_MUI_INTLSETTINGS_UILANG_NOT_INSTALLED = 15107;

        /// <summary>Locale installation failed</summary>
        public const UInt32  ERROR_MUI_INTLSETTINGS_INVALID_LOCALE_NAME = 15108;            
    }
    /// <summary>
    /// Configuration Manager error codes as defined in cfgmgr32.h
    /// </summary>
    public static class CfgMgr32ErrorCodes
    {
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_SUCCESS = (0x00000000);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEFAULT = (0x00000001);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_OUT_OF_MEMORY = (0x00000002);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_POINTER = (0x00000003);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_FLAG = (0x00000004);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_DEVNODE = (0x00000005);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_DEVINST = CR_INVALID_DEVNODE;
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_RES_DES = (0x00000006);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_LOG_CONF = (0x00000007);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_ARBITRATOR = (0x00000008);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_NODELIST = (0x00000009);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEVNODE_HAS_REQS = (0x0000000A);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEVINST_HAS_REQS = CR_DEVNODE_HAS_REQS;
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_RESOURCEID = (0x0000000B);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DLVXD_NOT_FOUND = (0x0000000C);   // WIN 95 ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_DEVNODE = (0x0000000D);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_DEVINST = CR_NO_SUCH_DEVNODE;
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_MORE_LOG_CONF = (0x0000000E);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_MORE_RES_DES = (0x0000000F);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_ALREADY_SUCH_DEVNODE = (0x00000010);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_ALREADY_SUCH_DEVINST = CR_ALREADY_SUCH_DEVNODE;
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_RANGE_LIST = (0x00000011);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_RANGE = (0x00000012);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_FAILURE = (0x00000013);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_LOGICAL_DEV = (0x00000014);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_CREATE_BLOCKED = (0x00000015);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NOT_SYSTEM_VM = (0x00000016);   // WIN 95 ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_REMOVE_VETOED = (0x00000017);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_APM_VETOED = (0x00000018);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_LOAD_TYPE = (0x00000019);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_BUFFER_SMALL = (0x0000001A);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_ARBITRATOR = (0x0000001B);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_REGISTRY_HANDLE = (0x0000001C);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_REGISTRY_ERROR = (0x0000001D);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_DEVICE_ID = (0x0000001E);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_DATA = (0x0000001F);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_API = (0x00000020);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEVLOADER_NOT_READY = (0x00000021);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NEED_RESTART = (0x00000022);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_MORE_HW_PROFILES = (0x00000023);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEVICE_NOT_THERE = (0x00000024);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_VALUE = (0x00000025);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_WRONG_TYPE = (0x00000026);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_PRIORITY = (0x00000027);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NOT_DISABLEABLE = (0x00000028);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_FREE_RESOURCES = (0x00000029);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_QUERY_VETOED = (0x0000002A);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_CANT_SHARE_IRQ = (0x0000002B);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_DEPENDENT = (0x0000002C);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_SAME_RESOURCES = (0x0000002D);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_REGISTRY_KEY = (0x0000002E);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_MACHINENAME = (0x0000002F);   // NT ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_REMOTE_COMM_FAILURE = (0x00000030);   // NT ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_MACHINE_UNAVAILABLE = (0x00000031);   // NT ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_CM_SERVICES = (0x00000032);   // NT ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_ACCESS_DENIED = (0x00000033);   // NT ONLY
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_CALL_NOT_IMPLEMENTED = (0x00000034);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_PROPERTY = (0x00000035);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_DEVICE_INTERFACE_ACTIVE = (0x00000036);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_NO_SUCH_DEVICE_INTERFACE = (0x00000037);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_REFERENCE_STRING = (0x00000038);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_CONFLICT_LIST = (0x00000039);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_INDEX = (0x0000003A);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 CR_INVALID_STRUCTURE_SIZE = (0x0000003B);
        /// <summary>Configuration Manager error code from cfgmgr32.h</summary>
        public static UInt32 NUM_CR_RESULTS = (0x0000003C);
    }
}