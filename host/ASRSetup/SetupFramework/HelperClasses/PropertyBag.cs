...
namespace ASRSetupFramework
{
    ...
    public class PropertyBagDictionary : IDictionary<string, object>
    {
        ...
        public const string SkipPrereqChecks = "skipprereqchecks";
        ...
        public const string PlatformChange = "platformchange";
        ...
        /// </summary>
        /// <param name="key">The key to be set or get.</param>
        ...
        public static void LogPropertyBag()
        {
            ...
            {
                if (IsProtectedProperty(pair.Key))
                {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Justification = "No type param required")]
        ...
        /// <param name="value">The value associated to key.</param>
