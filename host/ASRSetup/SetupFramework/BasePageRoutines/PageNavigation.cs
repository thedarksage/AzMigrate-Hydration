...
namespace ASRSetupFramework
{
    ...
    public class PageNavigation
    {
        ...
        /// </summary>
        /// <param name="shouldValidate">Should the page be validated. Default is true.</param>
        public void MoveToNextPage(bool shouldValidate = true)
        {
            this.NavigateToPage(Navigation.Next, null, shouldValidate);
        }
        ...
        /// </summary>
        /// <param name="shouldValidate">Should the page be validated. Default is true.</param>
        public void MoveToPreviousPage(bool shouldValidate = true)
        {
            this.NavigateToPage(Navigation.Previous, null, shouldValidate);
        }
        ...
        /// <param name="jumpPage">page name when applicabl.e</param>
        /// <param name="shouldValidate">If ValidatePage is to be run before proceeding to page.</param>
        private void NavigateToPage(Navigation navigation, string jumpPage, bool shouldValidate)
        {
            // Page must validate if it should
            if (shouldValidate &&
                (!this.currentPage.PageUI.ValidatePage(navigation, jumpPage)))
            {
                return;
            }
