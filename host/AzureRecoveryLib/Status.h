...
#define E_RECOVERY_DISK_CONVERSION_VALIDATION_FAILED 39

#define E_RECOVERY_DISK_CONVERSION_FAILED 40

#define E_RECOVERY_UNSUPPORTED_PARTITION_STYLE 41

#define E_RECOVERY_ESP_PARTITION_CREATION_FAILED 42

#define E_RECOVERY_INSUFFICIENT_SPACE_FOR_ESP_PARTITION 43
