...
void scst_set_cmd_error(struct scst_cmd *cmd, inm_s32_t key, inm_s32_t asc, inm_s32_t ascq)
{
	return;
}
...
inm_s32_t filter_lun_create(char* uuid, inm_u64_t nblks, inm_u32_t bsize, inm_u64_t startoff)
{
	return 0;
}
