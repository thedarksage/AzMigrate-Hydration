#ifndef _INMAGE_SEGMENT_MAPPER_H_
#define _INMAGE_SEGMENT_MAPPER_H_
...
public:
    ...
    virtual NTSTATUS UnlockAndMarkDirty(ULONG64 offset, ULONG32 size) = 0; // useful if we modified data
...
#endif //_INMAGE_SEGMENT_MAPPER_H_
