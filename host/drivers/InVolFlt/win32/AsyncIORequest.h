#ifndef _INMAGE_ASYNC_IO_REQUEST_H_
#define _INMAGE_ASYNC_IO_REQUEST_H_
...
public:
    ...
    virtual NTSTATUS Read(PVOID buffer, ULONG32 size, ULONG64 offset);
    virtual NTSTATUS Write(PVOID buffer, ULONG32 size, ULONG64 offset);
...
protected:
    virtual NTSTATUS ReadWrite(PVOID buffer, ULONG32 size, ULONG64 offset, ULONG32 IrpMJ);
...
#endif // _INMAGE_ASYNC_IO_REQUEST_H_
