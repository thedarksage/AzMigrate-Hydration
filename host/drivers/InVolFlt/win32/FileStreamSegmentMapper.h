#ifndef _INMAGE_FILE_STREAM_SEGMENT_MAPPER_H_
#define _INMAGE_FILE_STREAM_SEGMENT_MAPPER_H_
...
public:
    void * __cdecl operator new(size_t size) {return malloc(size, TAG_FSSEGMENTMAPPER_OBJECT, NonPagedPool);};
    ...
    virtual NTSTATUS UnlockAndMarkDirty(ULONG64 offset, ULONG32 size); // useful if we modified data
...
#endif //_INMAGE_FILE_STREAM_SEGMENT_MAPPER_H_
