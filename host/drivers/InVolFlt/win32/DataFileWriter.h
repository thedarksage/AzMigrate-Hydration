#ifndef _INVOLFLT_DATA_FILE_WRITER_H_
#define _INVOLFLT_DATA_FILE_WRITER_H_
#include "BaseClass.h"
#include "DataFile.h"
...
public:
    ...
    NTSTATUS AddChangeNode(PCHANGE_NODE ChangeNode, _VOLUME_CONTEXT *VolumeContext);
...
private:
    ...
    void ProcessChangeNode(PFILE_WRITER_THREAD FileWriterThread, PCHANGE_NODE ChangeNode, _VOLUME_CONTEXT *VolumeContext);
    void AbortChangeNode(PCHANGE_NODE ChangeNode, _VOLUME_CONTEXT *VolumeContext);
...
#endif // _INVOLFLT_DATA_FILE_WRITER_H_
