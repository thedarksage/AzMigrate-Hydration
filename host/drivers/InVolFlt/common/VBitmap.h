...
/* TODOs: in linux, we won't find volume letter ... */
...
typedef struct _volume_bitmap {
    ...
    inm_u32_t       bitmap_skip_writes; /* NOTE: not protected by sem */
} volume_bitmap_t;

/*
  typedef enum _bitmap_work_item_state_t
  {
