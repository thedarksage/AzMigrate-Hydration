...
#define TELEMETRY_WTIME_OFF             116444736000000000ULL  /* Win epoch */
...
typedef enum _etTagStateTriggerReason {
    ...
    ecOrphan,                           /* LIN: Orphan dropped on S2 exit   */
...
typedef struct driver_telemetry {
    ...
    inm_u64_t	    dt_svagent_start_time;	    /* Svagent start time	    */
    inm_u64_t	    dt_svagent_stop_time;		/* Svagent stop time	    */
    inm_u64_t	    dt_s2_start_time;		    /* S2 start time		    */
    inm_u64_t	    dt_s2_stop_time;		    /* S2 stop time			    */
