 ...
 *
 * File       : involflt-common.h
 *
 * Description: Common Header Files and #defines required for building
 * involflt c files.
 */
...
/* TODOs: Error numbers logged to registry when volume is out of sync */
...
#ifndef FILTER_DRIVER_PRIVATE_BUILD
#include "../../../../common/version.h"
#else
#define INMAGE_PRODUCT_VERSION_MAJOR 1
#define INMAGE_PRODUCT_VERSION_MINOR 2
#define INMAGE_PRODUCT_VERSION_PRIVATE 3
#define INMAGE_PRODUCT_VERSION_BUILDNUM 456
#endif
