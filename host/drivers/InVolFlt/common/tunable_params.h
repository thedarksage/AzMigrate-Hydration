...
/*
  #define DEFAULT_DB_HIGH_WATERMARK_SERVICE_NOT_STARTED   0x20  // 8K Changes.
  #define DEFAULT_DB_LOW_WATERMARK_SERVICE_RUNNING        0x40  // 16K Changes
  #define DEFAULT_DB_HIGH_WATERMARK_SERVICE_RUNNING       0x100 // 64K
  #define DEFAULT_DB_HIGH_WATERMARK_SERVICE_SHUTDOWN      0x080  // 2K Changes.
  #define DEFAULT_DB_TO_PURGE_HIGH_WATERMARK_REACHED      0x20 // 8K
*/
