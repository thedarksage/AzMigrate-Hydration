...
{
    unsigned char    VolumeGUID[GUID_SIZE_IN_CHARS]; 
    inm_s32_t         Seconds; //Maximum time to wait in the kernel
} WAIT_FOR_DB_NOTIFY;
...
/* Sysfs definitions for volume objects
 */
...
#define REPLICATION_STATES_SUPPORTED          \
                                (REPLICATION_STATE_DIFF_SYNC_THROTTLED)
