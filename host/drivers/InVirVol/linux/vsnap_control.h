 ...
 * Last Modified:       $Date: 2012/08/06 07:12:14 $
 *
 * $Log: vsnap_control.h,v $
 * Revision 1.11  2012/08/06 07:12:14  hpadidakul
 * Adding number of device support to 16.
 *
 * Revision 1.10  2011/02/14 13:19:13  chvirani
 * Revert linux full disk changes
 *
 * Revision 1.9  2011/02/03 09:42:26  hpadidakul
 * Full disk support on Linux.
 * The code changes was to send number of partitions(minor) to the alloc_disk & add_disk.
 * And add_disk routine will take care of reading and creating partitions.
 *
 * Smokianide test done by: Neela Lohith Koundinya.
 *
 * Unit test done by: Hari
 *
 * Revision 1.8  2010/10/01 09:05:00  chvirani
...
/* used as input for alloc_disk while creating the disks */
#define INM_VSNAP_NUM_DEVICES	16

/* Minor Macros */
#define INM_VSNAP_MINOR_START	0
#define INM_MAX_VSNAP			0xffff
