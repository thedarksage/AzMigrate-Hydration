...
#define SOL_TARGETCHAR 't'
#define SOL_LUNCHAR 'd'
#define SLICECHAR 's'
...
#define SHOWFCPDEVARG "show_FCP_dev"
...
const char * const cfgadmopts[] = {"", "f", "c", "fc"};
...
const GetATCountFromPI_t GetATCountFromPI[] = {
                                               ...
                                               GetATCountFromLpfcPI, GetATCountFromiScsiPI
                                              };
...
bool DummyLunInCfgAdmOld(const LocalPwwnInfo_t &lpwwn,
                                const RemotePwwnInfo_t &rpwwn, 
                                const SV_ULONGLONG *patlunnumber);

bool DummyLunInCfgAdm(const LocalPwwnInfo_t &lpwwn,
                                const RemotePwwnInfo_t &rpwwn, 
                                const SV_ULONGLONG *patlunnumber);
...
const FcInfoScan_t FcInfoScan[] = {FcInfoLunNormalScan};
...
const FcInfoClean_t FcInfoClean[] = {IsFcInfoLunCleaned};
