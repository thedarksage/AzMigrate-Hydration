...
const char KEY_ENABLE_FR_LOG_FILE_DELETION[] = "EnableFrLogFileDeletion";
...
const char KEY_ENABLE_ENCRYPTION[] = "EnableEncryption";
const char KEY_FR_REGISTER_HOST_INTERVEL[] = "RegisterHostIntervel";
const char KEY_SV_TCP_SEND_WNDSIZE[] = "TcpSendBufSize";
const char KEY_SV_TCP_RECV_WNDSIZE[] = "TcpRecvBufSize";
const char KEY_MAX_FR_LOG_PAYLOAD[] = "MaxFrLogPayload";
const char KEY_REMOTE_CX_INFO[] = "RemoteCXInfo";
...
const char KEY_SSHD_SUPPORTED[] = "SSHD_SUPPORTED";
//Added for Https
const char KEY_HTTPS[] = "Https";
const char KEY_FXUPGRADED[] = "IsFxUpgraded";
