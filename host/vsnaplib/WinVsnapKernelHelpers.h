...
#define FILE_DEFAULT_CREATE_OPTIONS     FILE_SYNCHRONOUS_IO_NONALERT | FILE_WRITE_THROUGH | FILE_RANDOM_ACCESS | FILE_NON_DIRECTORY_FILE
...
inline void STRING_COPY(char *dest, char *src, int len)
{
...
void *ALLOC_MEMORY(int, POOL_TYPE);
