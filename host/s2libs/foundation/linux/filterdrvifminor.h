...
public:
    ...
    bool GetVolumeBlockSizeFromSysFs(const std::string &devicename, SV_ULONGLONG &blksz, std::string &reasonifcant);
    bool GetNumberOfBlocksInVolume(const std::string &devicename, DeviceStream *pDeviceStream, SV_ULONGLONG &nblks, const int &errorfromgetattr, 
                                   std::string &reasonifcant);
    bool GetNumberOfBlocksInVolumeFromSysFs(const std::string &devicename, SV_ULONGLONG &nblks, std::string &reasonifcant);
};
