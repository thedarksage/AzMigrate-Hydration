...
#
#
$global:ApplicationId  = "cd4b44ea-153d-4311-95f1-19e83a9aa93a"
$global:TenantId       = "72f988bf-86f1-41af-91ab-2d7cd011db47"

# Read A2A GQL Configuration File

if ($global:MT -eq $true) {
    $global:configFile = $global:LogDir + "\" + "$global:BranchRunPrefix" + "-" + "$global:OSName" + "\A2AGQLConfig.xml"    
} else {
