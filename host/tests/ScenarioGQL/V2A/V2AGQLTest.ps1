...
Function SwitchProtection {
    ...
    $mtDataStore = $mtAccount.DataStores | Where-Object { $_.SymbolicName -match $mtObj.DataStore }
    $retVolume = $mtAccount.RetentionVolumes | Where-Object { $_.volumeName -match $mtObj.Retention }
...
Function DeleteFailoverVM {
    ...
    RemoveAzureVM -ResourceGroupName $global:RecResourceGroup -VMName $global:SourceFriendlyName
