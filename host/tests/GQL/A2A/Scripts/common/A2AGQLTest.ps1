...
Function TestFailover
{
	...
	# Get Custom tag
	[PSObject]$recoveryPoint = GetRecoveryPoint -protectedItemObject $protectedItemObject -tagType "Custom"
...
Function Failback
{
	...
	# Get Custom tag
	[PSObject]$recoveryPoint = GetRecoveryPoint -protectedItemObject $reverseProtectedItemObject -tagType "Custom"
...
Function CleanupResources
{
	...
	LogMessage -Message ("Removing ResourgeGroup:{0} and all its artifacts" -f $global:RecResourceGroup) -Type 1
