...
$Scenarios = @{
    # Key = @(RowID, Columns ... )
	A2A_GQL = @("VM", "OS", "Kernel", "Agent", "CreateConfig", "CleanPreviousRun", "CreateVM","Reboot", "ER_180", "TFO", "FO_180", "DI_180", "ER_360","FO_360","DI_360", "ER_540", "DI_540", "DisableRep", "CleanRep")
	...
	BUILD = @("Branch", "Debian7", "Debian8", "Debian9", "Debian10", "OL6", "OL7", "OL8", "RHEL5", "RHEL6", "RHEL7", "RHEL8", "SLES11-SP3", "SLES11-SP4", "SLES12", "SLES15", "UBUNTU-14.04", "UBUNTU-16.04", "UBUNTU-18.04","UBUNTU-20.04", "Windows", "PS.msi", "UnifiedSetup", "PSGImage")
}
...
Function InitVars()
{
    ...
    $global:LogFilePath = $StatusDirPath + "\status.log"

	$global:StatusSAccount = "srctestlogs"
	$global:StatusContainer = "testlogs"
	# Git does not allow code with auth hash/creds.
	#$global:SASToken = ""
	$global:SASToken = ""
