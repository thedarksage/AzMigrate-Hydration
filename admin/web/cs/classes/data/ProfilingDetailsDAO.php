...
/**
  ...
  *
  * profilingDetails Data Access Object[DAO]
  * This class contains all database handling that is needed to 
  * permanently store and retrieve profilingDetails object instances. 
  * Generated Date:	Tue, 27 Nov 2007 14:01:26 +0530	
  * Pattern Version:1.0
  */
class ProfilingDetailsDAO
{
...
function findByPrimaryKey($conn, $valueObject) {
	...
	$sql = "SELECT * FROM profilingDetails WHERE (id = '".$valueObject->get_id()."') "; 
...
function findAll($conn) {
	...
	$sql = "SELECT * FROM profilingDetails ORDER BY id ASC ";
...
function create($conn, $valueObject) {
	 $count = 0;
     $sql1 = "INSERT INTO profilingDetails(";
     $sql3 = ") VALUES ("; 
	 ...
	 if ($valueObject->isset_cumulative_compression())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."cumulativeCompression";
 	    $sql4 = $sql4."'".$valueObject->get_cumulative_compression()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_cumulative_un_compression())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."cumulativeUnCompression";
 	    $sql4 = $sql4."'".$valueObject->get_cumulative_un_compression()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_for_date())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."forDate";
 	    $sql4 = $sql4."'".$valueObject->get_for_date()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_from_update())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."fromUpdate";
 	    $sql4 = $sql4."'".$valueObject->get_from_update()."'"; 	
 		$count++;
 	 }
...
function update($conn, $valueObject) {
	$count = 0;
	$sql = "UPDATE profilingDetails SET ";
	if ($valueObject->isset_id())
 	{
		if($count>0)
		{
	...
	if ($valueObject->isset_cumulative_compression())
 	{
		...
		$sql = $sql."cumulativeCompression = '".$valueObject->get_cumulative_compression()."'";
		$count++;
	}
	...
	if ($valueObject->isset_cumulative_un_compression())
 	{
		...
		$sql = $sql."cumulativeUnCompression = '".$valueObject->get_cumulative_un_compression()."'";
		$count++;
	}
	...
	if ($valueObject->isset_for_date())
 	{
		...
		$sql = $sql."forDate = '".$valueObject->get_for_date()."'";
		$count++;
	}
	...
	if ($valueObject->isset_from_update())
 	{
		...
		$sql = $sql."fromUpdate = '".$valueObject->get_from_update()."'";
		$count++;
	}
...
function delete($conn, $valueObject) {
	...
	$sql = "DELETE FROM profilingDetails WHERE (id = '".$valueObject->get_id()."')"; 
	$result = $this->databaseUpdate($conn, $sql);
    if ($result != 1) {
         //print "PrimaryKey Error when updating DB!";
          return false;
...
function deleteAll($conn) {
	$sql = "DELETE FROM profilingDetails";
	$result = $this->databaseUpdate($conn, $sql);
	return true;
}
...
function countAll($conn) {
	$sql = "SELECT count(*) FROM profilingDetails";
	$allRows = 0;
...
function searchMatching($conn, $valueObject) {
	$first = true;
    $sql = "SELECT * FROM profilingDetails WHERE 1=1 ";
	...
	if ($valueObject->get_cumulative_compression() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND cumulativeCompression LIKE '".$valueObject->get_cumulative_compression()."%' ";
    }
	
	if ($valueObject->get_cumulative_un_compression() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND cumulativeUnCompression LIKE '".$valueObject->get_cumulative_un_compression()."%' ";
    }
	
	if ($valueObject->get_for_date() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND forDate LIKE '".$valueObject->get_for_date()."%' ";
    }
	
	if ($valueObject->get_from_update() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND fromUpdate LIKE '".$valueObject->get_from_update()."%' ";
    }
