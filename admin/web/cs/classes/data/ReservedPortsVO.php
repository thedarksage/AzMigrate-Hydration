...
function ReservedPortsVO(){

}

/*
	function ReservedPortsVO(fabricIdIn,portWwnIn){
 ...
 */
function setAll($portWwnIn,$fabricIdIn,$nodeWwnIn,$symbolicNameIn){
	$this->portWwn=$portWwnIn;
	$this->fabricId=$fabricIdIn;
	$this->nodeWwn=$nodeWwnIn;
	$this->symbolicName=$symbolicNameIn;
...
function toString() {
	...
	$out = $out."\nclass ReservedPortsVO, mapping to table reservedPorts\n";
