...
function SanTargetsVO(){

}

/*
	function SanTargetsVO(fabricIdIn,sanTargetPortWwnIn){
 ...
 */
function setAll($sanTargetPortWwnIn,$fabricIdIn){
	$this->sanTargetPortWwn=$sanTargetPortWwnIn;
	$this->fabricId=$fabricIdIn;
}
...
function toString() {
	...
	$out = $out."\nclass SanTargetsVO, mapping to table sanTargets\n";
