...
/**
  ...
  *
  * retentionTag Data Access Object[DAO]
  * This class contains all database handling that is needed to 
  * permanently store and retrieve retentionTag object instances. 
  * Generated Date:	Tue, 27 Nov 2007 14:01:28 +0530	
  * Pattern Version:1.0
  */
class RetentionTagDAO
{
...
function create($conn, $valueObject) {
	 ...
	 if ($valueObject->isset_tag_time_stamp())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."tagTimeStamp";
 	    $sql4 = $sql4."'".$valueObject->get_tag_time_stamp()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_app_name())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."appName";
 	    $sql4 = $sql4."'".$valueObject->get_app_name()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_user_tag())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."userTag";
 	    $sql4 = $sql4."'".$valueObject->get_user_tag()."'"; 	
 		$count++;
 	 }
	 ...
	 if ($valueObject->isset_padded_tag_time_stamp())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."paddedTagTimeStamp";
 	    $sql4 = $sql4."'".$valueObject->get_padded_tag_time_stamp()."'"; 	
 		$count++;
 	 }
...
function countAll($conn) {
	$sql = "SELECT count(*) FROM retentionTag";
	$allRows = 0;
...
function searchMatching($conn, $valueObject) {
	$first = true;
    $sql = "SELECT * FROM retentionTag WHERE 1=1 ";
	...
	if ($valueObject->get_tag_time_stamp() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND tagTimeStamp LIKE '".$valueObject->get_tag_time_stamp()."%' ";
    }
	
	if ($valueObject->get_app_name() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND appName LIKE '".$valueObject->get_app_name()."%' ";
    }
	
	if ($valueObject->get_user_tag() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND userTag LIKE '".$valueObject->get_user_tag()."%' ";
    }
	...
	if ($valueObject->get_padded_tag_time_stamp() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND paddedTagTimeStamp LIKE '".$valueObject->get_padded_tag_time_stamp()."%' ";
    }
