 ...
 *
 * exportedITLNexus Value Object[VO]
...
public $exportedInitiatorPortWwn;
...
function ExportedITLNexusVO(){

}

/*
	function ExportedITLNexusVO(exportedInitiatorPortWwnIn,exportedLunIdIn,exportedLunNumberIn,exportedTargetPortWwnIn,fabricIdIn,processServerIdIn){
 this->exportedInitiatorPortWwn=$exportedInitiatorPortWwnIn;
...
function get_exported_initiator_port_wwn() {
	return $this->exportedInitiatorPortWwn;
}
function set_exported_initiator_port_wwn($exportedInitiatorPortWwnIn) { 
	$this->exportedInitiatorPortWwn=$exportedInitiatorPortWwnIn;
}

function isset_exported_initiator_port_wwn() {
	return isset($this->exportedInitiatorPortWwn);
}
 ...
 */
function setAll($exportedLunNumberIn,$exportedTargetPortWwnIn,$processServerIdIn,$fabricIdIn,$exportedLunIdIn,$exportedInitiatorPortWwnIn){
	$this->exportedLunNumber=$exportedLunNumberIn;
	$this->exportedTargetPortWwn=$exportedTargetPortWwnIn;
	$this->processServerId=$processServerIdIn;
	$this->fabricId=$fabricIdIn;
...
function setAry($ary){ 
	...
	$this->exportedInitiatorPortWwn=$ary["exportedInitiatorPortWwn"];
}
...
function getAry(){ 
	...
	else
	{
		...
		$oAry["exportedInitiatorPortWwn"]=$this->exportedInitiatorPortWwn;
	}
	return $oAry;
} 
...
function hasEqualMapping($valueObject){
	...
	if ($valueObject->get_exported_initiator_port_wwn() != $this->exportedInitiatorPortWwn) {
		return(false);
	}
    return true;
 }
...
function toString() {
	...
	$out = $out."\nclass ExportedITLNexusVO, mapping to table exportedITLNexus\n";
	...
	$out = $out."exportedInitiatorPortWwn = ".$this->exportedInitiatorPortWwn."\n";
	return $out;
}
...
function __clone() {
	$cloned = new ExportedITLNexusVO();
	 ...
	 $cloned->set_exported_initiator_port_wwn($this->exportedInitiatorPortWwn);
