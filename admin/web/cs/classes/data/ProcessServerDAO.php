...
/**
  ...
  *
  * processServer Data Access Object[DAO]
  * This class contains all database handling that is needed to 
  * permanently store and retrieve processServer object instances. 
  * Generated Date:	Mon, 28 Apr 2008 12:05:42 +0530	
  * Pattern Version:1.0
  */
class ProcessServerDAO
{
 ...
 */
function getObject($conn,$processServerId) {
...
function findByPrimaryKey($conn, $valueObject) {
	...
	$sql = "SELECT * FROM processServer WHERE (processServerId = '".$valueObject->get_process_server_id()."') "; 
...
function findAll($conn) {
	...
	$sql = "SELECT * FROM processServer ORDER BY processServerId ASC ";
...
function create($conn, $valueObject) {
	 $count = 0;
     $sql1 = "INSERT INTO processServer(";
     $sql3 = ") VALUES ("; 
...
function update($conn, $valueObject) {
	...
	$sql = $sql." WHERE (processServerId = '".$valueObject->get_process_server_id()."')"; 
	$result = $this->databaseUpdate($conn, $sql);
    if ($result != 1) {
...
function delete($conn, $valueObject) {
	...
	$sql = "DELETE FROM processServer WHERE (processServerId = '".$valueObject->get_process_server_id()."')"; 
	$result = $this->databaseUpdate($conn, $sql);
    if ($result != 1) {
         //print "PrimaryKey Error when updating DB!";
          return false;
...
function countAll($conn) {
	$sql = "SELECT count(*) FROM processServer";
	$allRows = 0;
...
function searchMatching($conn, $valueObject) {
	$first = true;
    $sql = "SELECT * FROM processServer WHERE 1=1 ";
