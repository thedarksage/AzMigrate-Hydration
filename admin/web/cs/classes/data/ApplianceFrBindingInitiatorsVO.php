 ...
 *
 * applianceFrBindingInitiators Value Object[VO]
...
class ApplianceFrBindingInitiatorsVO
{
...
public $applianceFrBindingInitiatorPortWwn;
...
function ApplianceFrBindingInitiatorsVO(){

}

/*
	function ApplianceFrBindingInitiatorsVO(applianceFrBindingInitiatorPortWwnIn,fabricIdIn,processServerIdIn){
 this->applianceFrBindingInitiatorPortWwn=$applianceFrBindingInitiatorPortWwnIn;
...
function get_appliance_fr_binding_initiator_port_wwn() {
	return $this->applianceFrBindingInitiatorPortWwn;
}
function set_appliance_fr_binding_initiator_port_wwn($applianceFrBindingInitiatorPortWwnIn) { 
	$this->applianceFrBindingInitiatorPortWwn=$applianceFrBindingInitiatorPortWwnIn;
}

function isset_appliance_fr_binding_initiator_port_wwn() {
	return isset($this->applianceFrBindingInitiatorPortWwn);
}
 ...
 */
function setAll($applianceFrBindingInitiatorPortWwnIn,$processServerIdIn,$fabricIdIn,$stateIn,$errorIn){
	$this->applianceFrBindingInitiatorPortWwn=$applianceFrBindingInitiatorPortWwnIn;
	$this->processServerId=$processServerIdIn;
	$this->fabricId=$fabricIdIn;
	$this->state=$stateIn;
...
function setAry($ary){ 
	$this->ary=$ary;
	$this->applianceFrBindingInitiatorPortWwn=$ary["applianceFrBindingInitiatorPortWwn"];
...
function getAry(){ 
	...
	{
		$oAry["applianceFrBindingInitiatorPortWwn"]=$this->applianceFrBindingInitiatorPortWwn;
...
function hasEqualMapping($valueObject){
	if ($valueObject->get_appliance_fr_binding_initiator_port_wwn() != $this->applianceFrBindingInitiatorPortWwn) {
		return(false);
	}
...
function toString() {
	...
	$out = $out."\nclass ApplianceFrBindingInitiatorsVO, mapping to table applianceFrBindingInitiators\n";
	$out = $out."Persistent attributes: \n";
	$out = $out."applianceFrBindingInitiatorPortWwn = ".$this->applianceFrBindingInitiatorPortWwn."\n";
 ...
 */
function __clone() {
	$cloned = new ApplianceFrBindingInitiatorsVO();
	
	 $cloned->set_appliance_fr_binding_initiator_port_wwn($this->applianceFrBindingInitiatorPortWwn);
