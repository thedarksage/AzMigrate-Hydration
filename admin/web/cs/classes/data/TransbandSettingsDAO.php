...
/**
  ...
  *
  * transbandSettings Data Access Object[DAO]
  * This class contains all database handling that is needed to 
  * permanently store and retrieve transbandSettings object instances. 
  * Generated Date:	Tue, 27 Nov 2007 14:01:30 +0530	
  * Pattern Version:1.0
  */
class TransbandSettingsDAO
{
...
function createValueObject() {
	return new TransbandSettingsVO();
 }
...
function findByPrimaryKey($conn, $valueObject) {
	...
	$sql = "SELECT * FROM transbandSettings WHERE (id = '".$valueObject->get_id()."') "; 
...
function findAll($conn) {
	...
	$sql = "SELECT * FROM transbandSettings ORDER BY id ASC ";
...
function create($conn, $valueObject) {
	 $count = 0;
     $sql1 = "INSERT INTO transbandSettings(";
     $sql3 = ") VALUES ("; 
...
function update($conn, $valueObject) {
	$count = 0;
	$sql = "UPDATE transbandSettings SET ";
	if ($valueObject->isset_id())
 	{
		if($count>0)
		{
...
function delete($conn, $valueObject) {
	...
	$sql = "DELETE FROM transbandSettings WHERE (id = '".$valueObject->get_id()."')"; 
	$result = $this->databaseUpdate($conn, $sql);
    if ($result != 1) {
         //print "PrimaryKey Error when updating DB!";
          return false;
...
function deleteAll($conn) {
	$sql = "DELETE FROM transbandSettings";
	$result = $this->databaseUpdate($conn, $sql);
	return true;
}
...
function countAll($conn) {
	$sql = "SELECT count(*) FROM transbandSettings";
	$allRows = 0;
...
function searchMatching($conn, $valueObject) {
	$first = true;
    $sql = "SELECT * FROM transbandSettings WHERE 1=1 ";
