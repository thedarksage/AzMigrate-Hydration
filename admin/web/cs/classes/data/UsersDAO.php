	 ...
	 if ($valueObject->isset_uname())
 	 {
 	  	if($count>0)
		{
 	    ...
 	    $sql2 = $sql2."uname";
 	    $sql4 = $sql4."'".$valueObject->get_uname()."'"; 	
 		$count++;
 	 }
	 ...
	 if ($valueObject->isset_passwd())
 	 {
 	  	if($count>0)
		{
 	    ...
 	    $sql2 = $sql2."passwd";
 	    $sql4 = $sql4."'".$valueObject->get_passwd()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_email())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."email";
 	    $sql4 = $sql4."'".$valueObject->get_email()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_mails_enabled())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."mailsEnabled";
 	    $sql4 = $sql4."'".$valueObject->get_mails_enabled()."'"; 	
 		$count++;
 	 }
	 
	 if ($valueObject->isset_sessiontimeout())
 	 {
 	  	if($count>0)
		{
			$sql2 = $sql2 . ",";
 	    ...
 	    $sql2 = $sql2."sessiontimeout";
 	    $sql4 = $sql4."'".$valueObject->get_sessiontimeout()."'"; 	
 		$count++;
 	 }
...
function searchMatching($conn, $valueObject) {
	...
	if ($valueObject->get_uname() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND uname LIKE '".$valueObject->get_uname()."%' ";
    }
	...
	if ($valueObject->get_passwd() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND passwd LIKE '".$valueObject->get_passwd()."%' ";
    }
	
	if ($valueObject->get_email() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND email LIKE '".$valueObject->get_email()."%' ";
    }
	
	if ($valueObject->get_mails_enabled() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND mailsEnabled LIKE '".$valueObject->get_mails_enabled()."%' ";
    }
	
	if ($valueObject->get_sessiontimeout() != "") {
    	if ($first) { $first = false; }
        $sql = $sql."AND sessiontimeout LIKE '".$valueObject->get_sessiontimeout()."%' ";
    }
