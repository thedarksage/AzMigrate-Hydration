...
function VolumeGroupsVO(){

}

/*
	function VolumeGroupsVO(idIn){
 this->id=$idIn;
}
*/
...
function set_display_name($displayNameIn) { 
	$this->displayName=$displayNameIn;
}

function isset_display_name() {
 ...
 */
function setAll($idIn,$displayNameIn){
	$this->id=$idIn;
	$this->displayName=$displayNameIn;
}
...
function setAry($ary){ 
	$this->ary=$ary;
	$this->id=$ary["id"];
	$this->displayName=$ary["displayName"];
}
...
function getAry(){ 
	...
	{
		$oAry["id"]=$this->id;
		$oAry["displayName"]=$this->displayName;
	}
	return $oAry;
} 
...
function hasEqualMapping($valueObject){
	...
	if ($valueObject->get_display_name() != $this->displayName) {
		return(false);
	}
    return true;
 }
...
function toString() {
	...
	$out = $out."\nclass VolumeGroupsVO, mapping to table volumeGroups\n";
	$out = $out."Persistent attributes: \n";
	$out = $out."id = ".$this->id."\n";
	$out = $out."displayName = ".$this->displayName."\n";
	return $out;
}
 ...
 */
function __clone() {
	$cloned = new VolumeGroupsVO();
	
	 $cloned->set_id($this->id);
	 $cloned->set_display_name($this->displayName);
