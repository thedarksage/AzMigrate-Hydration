...
use constant
{
     ...
     VOLSYNC_MAX			 =>	24,
	 SERVICES                        =>     ["monitor","monitor_ps","monitor_disks","volsync","scheduler","httpd","pushinstalld","heartbeat","gentrends","mysqld","bpm","cxps","wintc","array","prism"],
     WIN_SERVICES                    	 =>     ["monitor","monitor_ps","monitor_disks","volsync","scheduler","w3wp","pushinstall","heartbeat","gentrends","mysqld","bpm","cxps","rbp","ProcessServer","ProcessServerMonitor"],
...
use constant
{
    AUTHMETHOD_COMPAUTH => "ComponentAuth_V2015_01",
	AUTHMETHOD_CXAUTH => "CXAuth",
	AUTHMETHOD_MESSAGEAUTH => "MessageAuth"
};
...
use constant
{
    MDS_BACKEND_ERRORS => '9cc8c6e1-2bfb-4544-a850-a23c9ef8162d',
	MDS_BACKEND_ERROR_CODE => '1005'
};

use constant
{
    EC_PUSH_INSTALL_TIMED_OUT_WITHOUT_HEARTBEAT => 'EP0949',
	EC_PUSH_INSTALL_TIMED_OUT_WITH_HEARTBEAT => 'EP0950',
	EC_PUSH_UPGRADE_TIMED_OUT_WITHOUT_HEARTBEAT => 'EP0951',
	EC_PUSH_UPGRADE_TIMED_OUT_WITH_HEARTBEAT => 'EP0952'
};

use constant
{
    LOG_TO_MDS => 'MDS',
	LOG_TO_TELEMETRY => 'TELEMETRY',
	LOG_TO_MDS_AND_TELEMETRY => 'MDS_AND_TELEMETRY',
	METADATA_JSON => 'metadata.json',
	TELEMETRY_FOLDER_COUNT_FILE => '.telemetryfolderexhausted',
	TELEMETRY_FOLDER_COUNT_FILE_PATH => '\\home\\svsystems',
	SLASH => '\\',
	MAX_CHUNK_SIZE => 18*1024,
	JSON_EXTENTION => '.json',
	LOG_EXTENTION => '.log',
	RECORD_SEPARATOR => 'RECORD SEPARATOR',
	CS_LOGS_PATH => '\\home\\svsystems\\var\\cs_logs',
	CS_TELEMETRY_PATH => '\\home\\svsystems\\var\\cs_telemetry',
