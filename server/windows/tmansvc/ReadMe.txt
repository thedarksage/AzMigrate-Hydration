========================================================================
    ACTIVE TEMPLATE LIBRARY : tmansvc Project Overview
========================================================================

AppWizard has created this tmansvc project for you to use as the starting point for
...
tmansvc.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (tmansvc.h)
        GUID definitions                                (tmansvc_i.c)
        A type library                                  (tmansvc.tlb)
        Marshaling code                                 (tmansvc_p.c and dlldata.c)

tmansvc.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in tmansvc.idl. It will be regenerated by MIDL during compilation.
tmansvc.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named tmansvc.pch and a precompiled types file named StdAfx.obj.
...
tmansvcps.vcproj
	...
	dlldata.c, tmansvc_i.c and tmansvc_p.c which are required
