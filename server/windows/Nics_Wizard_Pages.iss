...
var
  ...
  CSDetailsPage_After_PSMultipleNicsWithoutPort_AfterServerChoicePage_Http, CSDetailsPage_After_PSMultipleNicsWithoutPort_AfterServerChoicePage_Https, GetpassphrasePage_After_CSDetailsPage_PS, CSUI_Login_Page_After_CSDetailsPage : TInputQueryWizardPage;
...
begin
      ...
      PIDetailsPage_After_CSMultipleNicsWithPort_AfterServerChoicePage := CreateInputQueryPage(CSUI_Login_Page_After_CSDetailsPage.ID,'Push Server Details','','Please enter following data and click Next.');
...
Procedure CSUILogin_Page_After_CSDetailsPage(); 
begin
			CSUI_Login_Page_After_CSDetailsPage := CreateInputQueryPage(CSMultipleNicsWithPort_AfterServerChoicePage_Http.ID,
													'CS UI login password Details',
													'',
													'Please enter following data and click Next.');
			CSUI_Login_Page_After_CSDetailsPage.Add('CS UI login password',True);
			
			Strong_Pwd_req_Link := TLabel.Create(WizardForm);
      Strong_Pwd_req_Link.Top := ScaleX(82);
      Strong_Pwd_req_Link.Left := WizardForm.InfoAfterPage.Left + 16;
      Strong_Pwd_req_Link.Font.Style := [fsBold];
      Strong_Pwd_req_Link.Caption := 'Note: Password must follow the rules below:'+#13#10+#13#10+'Password should contain at least one upper case letter'+#13#10+'Password should contain at least one lower case letter'+#13#10+'Password should contain at least one number'+#13#10+'Password should contain at least 8 characters in length';
      Strong_Pwd_req_Link.AutoSize := True;
      Strong_Pwd_req_Link.Parent := CSUI_Login_Page_After_CSDetailsPage.Surface; 
end;
...
begin
			GetpassphrasePage_After_CSDetailsPage_PS := CreateInputQueryPage(CSDetailsPage_After_PSMultipleNicsWithoutPort_AfterServerChoicePage_Http.ID,
													...
													'',
													'Please enter following data and click Next.');
			GetpassphrasePage_After_CSDetailsPage_PS.Add('Configuration Server Passphrase value',True);
end;
...
begin
      ...
      PIDetailsPage_After_PSMultipleNicsWithoutPort_After_CSMultipleNicsWithPort_AfterRoleOfCXServerPage_AfterServerChoicePage := CreateInputQueryPage(CSUI_Login_Page_After_CSDetailsPage.ID,'Push Server Details','','Please enter following data and click Next.');
...
begin
      ...
      PIDetailsPage_After_CSMultipleNicsWithPort_After_PSMultipleNicsWithoutPort_AfterServerChoicePage := CreateInputQueryPage(CSUI_Login_Page_After_CSDetailsPage.ID,'Push Server Details','','Please enter following data and click Next.');
...
begin
      ...
      PIDetailsPage_After_PrimaryCXDetailsPage := CreateInputQueryPage(CSUI_Login_Page_After_CSDetailsPage.ID,'Push Server Details','','Please enter following data and click Next.');
