...
{
    /// <summary>
    /// Defines a operation event to be logged.
    /// </summary>
    [EventData]
    public class OperationEvent : DiagnosticEventBase
    {
        /// <summary>
        /// The operation event version.
        /// </summary>
        /// <remarks>
        ...
        /// not.</param>
        public OperationEvent(bool fetchLogContext = true)
        {
            if (fetchLogContext)
            {
