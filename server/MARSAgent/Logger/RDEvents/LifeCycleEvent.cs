...
{
    /// <summary>
    /// Defines a life cycle event to be logged.
    /// </summary>
    [EventData]
    public class LifeCycleEvent : DiagnosticEventBase
    {
        /// <summary>
        /// The life cycle event version.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LifeCycleEvent" /> class.
        /// </summary>
        /// <param name="fetchLogContext">Specifies whether it is okay to fetch log context or
        /// not.</param>
        public LifeCycleEvent(bool fetchLogContext = true)
        {
            if (fetchLogContext)
            {
