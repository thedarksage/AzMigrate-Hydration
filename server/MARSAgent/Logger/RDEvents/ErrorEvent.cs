...
{
    /// <summary>
    /// Defines a error event to be logged.
    /// </summary>
    [EventData]
    public class ErrorEvent : ErrorEventBase
    {
        /// <summary>
        /// The error event version.
        /// </summary>
        /// <remarks>
        ...
        /// not.</param>
        public ErrorEvent(bool fetchLogContext = true)
        {
            if (fetchLogContext)
            {
        ...
        /// <summary>
        /// Gets or sets the error tags including category associated with exception.
        /// </summary>
