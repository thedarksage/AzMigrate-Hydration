...
public:
  enum
  {
  	// PR#10815: Long Path support for windows/unix
    DEFAULT_COMMAND_LINE_BUF_LEN = 4096,
...
protected:
...
#if defined (ACE_WIN32)
  ACE_TCHAR working_directory_[SV_ACE_UNICODE_PATH_MAX + 1];
  ...
  // PR#10815: Long Path support for windows/unix
#if defined (ACE_WIN32)
  ACE_TCHAR process_name_[SV_ACE_UNICODE_PATH_MAX + 1];
#else /* defined ACE_WIN32 */
