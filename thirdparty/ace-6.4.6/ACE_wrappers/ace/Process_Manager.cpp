  ...
  *status = 0;
  ...
  if (proc != 0)
  ...
  else
    {
      ...
      do
      {
          DWORD handle_count = this->current_count_ - current_index > 62 ? 62 : this->current_count_ - current_index;
          ...
          for (size_t i = 0;
              ...
              ++i)
              handles[i] =
              process_table_[i + current_index].process_->gethandle();
...
# endif
          ...
          current_index += handle_count;
          delete[] handles;
      }while( current_index != this->current_count_ ) ;
