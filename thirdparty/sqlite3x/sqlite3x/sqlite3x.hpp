...
namespace sqlite3x {
    ...
    public:
		...
		void setbusyhandler(int(*f)(void*,int),void * arg);
		int rowsmodified();
    ...
    public:
		typedef int sqlite3txn_behavior_t;

		static sqlite3txn_behavior_t const sqlite3txn_deferred  ;
		static sqlite3txn_behavior_t const sqlite3txn_immediate ;
		static sqlite3txn_behavior_t const sqlite3txn_exclusive ;


        sqlite3_transaction(sqlite3_connection &con, bool start=true, sqlite3txn_behavior_t txnbehavior = sqlite3txn_deferred);
        ~sqlite3_transaction();
    ...
    private:
        ...
        bool intrans;
		sqlite3txn_behavior_t txnbehavior;
