...
##            OpenSource
##+----------------------------------------------------------------------------------+
## File         :   PythonSetupPrereqs.sh
##
## Description  :   Installs python setuptools. Maintained at https://github.com/pypa/setuptools/tree/bootstrap.
##                  Official project repository for the Setuptools build system pypi.org/project/setuptools/
##
## History      :   29-01-2021 (Shantanu Mishra) - Added
##+----------------------------------------------------------------------------------+
