...
int mode2Filetype (umode_t mode)
{
   /* *INDENT-OFF* */
   static const struct {
      umode_t	mode;
...
/*
 * This function takes a umode_t type and creates a string represntation
 * of the permission mode.
 */
int mode2Char (char *string, umode_t mode)
{
   /* *INDENT-OFF* */
   static struct {
      umode_t	mask;
