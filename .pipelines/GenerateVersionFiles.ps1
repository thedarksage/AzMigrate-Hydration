...
function GenerateManifestDotTxt
{
	...
	$ManifestContents=[string]$ManifestContents + "Microsoft-ASR_UA_${ProductVersion}_DEBIAN11-64_${BuildPhase}_${BuildDate}_release.tar.gz,2,DEBIAN11-64,,${ProductVersion},Upgrade,no`r`n"
